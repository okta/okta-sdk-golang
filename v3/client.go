...
// APIClient manages communication with the Okta API API v2.8.1
...
type APIClient struct {
	...
	AuthenticatorApi *AuthenticatorApiService

	AuthorizationServerApi *AuthorizationServerApiService

	CAPTCHAApi *CAPTCHAApiService

	DomainApi *DomainApiService

	EventHookApi *EventHookApiService

	FeatureApi *FeatureApiService

	GroupApi *GroupApiService

	GroupSchemaApi *GroupSchemaApiService

	IdentityProviderApi *IdentityProviderApiService

	InlineHookApi *InlineHookApiService

	LinkedObjectApi *LinkedObjectApiService

	LogApi *LogApiService

	NetworkZoneApi *NetworkZoneApiService

	OrgApi *OrgApiService

	PolicyApi *PolicyApiService

	ProfileMappingApi *ProfileMappingApiService

	SessionApi *SessionApiService

	TemplateApi *TemplateApiService

	ThreatInsightApi *ThreatInsightApiService

	TrustedOriginApi *TrustedOriginApiService

	UserApi *UserApiService

	UserFactorApi *UserFactorApiService

	UserSchemaApi *UserSchemaApiService

	UserTypeApi *UserTypeApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.GroupSchemaApi = (*GroupSchemaApiService)(&c.common)
	...
	c.UserSchemaApi = (*UserSchemaApiService)(&c.common)
