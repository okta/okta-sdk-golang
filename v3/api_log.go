...
/*
LogApiService Fetch a list of events from your Okta organization system log.
The Okta System Log API provides read access to your organization’s system log. This API provides more functionality than the Events API
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *LogApiGetLogsOpts - Optional Parameters:
...
func (a *LogApiService) GetLogs(ctx context.Context, localVarOptionals *LogApiGetLogsOpts) ([]LogEvent, *http.Response, error) {
	var (
