...
func Test_can_activate_a_user(t *testing.T) {
	...
	profile["login"] = "SDK_TESTjohn-activate@example.com"
	u := &okta.CreateUserRequest{
		Credentials: uc,
		Profile:     &profile,
	}
...
func Test_can_update_user_profile(t *testing.T) {
	...
	profile["login"] = "SDK_TESTjohn-profile-update@example.com"
	u := &okta.CreateUserRequest{
		Credentials: uc,
		Profile:     &profile,
	}
...
func Test_can_suspend_a_user(t *testing.T) {
	...
	profile["login"] = "SDK_TESTjohn-suspend@example.com"
	u := &okta.CreateUserRequest{
		Credentials: uc,
		Profile:     &profile,
	}
...
func Test_can_change_users_password(t *testing.T) {
	...
	profile["login"] = "SDK_TESTjohn-change-password@example.com"
	u := &okta.CreateUserRequest{
		Credentials: uc,
		Profile:     &profile,
	}
...
func Test_can_get_reset_password_link_for_user(t *testing.T) {
	...
	profile["login"] = "SDK_TESTjohn-get-reset-password-url@example.com"
	u := &okta.CreateUserRequest{
		Credentials: uc,
		Profile:     &profile,
	}
...
func Test_can_expire_a_users_password_and_get_a_temp_one(t *testing.T) {
	...
	profile["login"] = "SDK_TESTjohn-expire-password@example.com"
	u := &okta.CreateUserRequest{
		Credentials: uc,
		Profile:     &profile,
	}
...
func Test_can_change_user_recovery_question(t *testing.T) {
	...
	profile["login"] = "SDK_TESTjohn-change-recovery-question@example.com"
	u := &okta.CreateUserRequest{
		Credentials: uc,
		Profile:     &profile,
	}
...
func Test_can_assign_a_user_to_a_role(t *testing.T) {
	...
	profile["login"] = "SDK_TESTjohn-role@example.com"
	u := &okta.CreateUserRequest{
		Credentials: uc,
		Profile:     &profile,
	}
...
func Test_user_group_target_role(t *testing.T) {
	...
	profile["login"] = "SDK_TESTjohn-group-target@example.com"
	u := &okta.CreateUserRequest{
		Credentials: uc,
		Profile:     &profile,
	}
...
func Test_can_get_user_with_cache_enabled(t *testing.T) {
	...
	profile["login"] = "SDK_TESTjohn-test-cache@example.com"
	u := &okta.CreateUserRequest{
		Credentials: uc,
		Profile:     &profile,
	}
	...
	for i := 0; i < 50; i++ {
		user, resp, err := client.User.GetUser(ctx, "SDK_TESTjohn-test-cache@example.com")
