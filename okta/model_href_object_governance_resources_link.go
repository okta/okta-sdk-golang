...
// checks if the HrefObjectGovernanceResourcesLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HrefObjectGovernanceResourcesLink{}

// HrefObjectGovernanceResourcesLink Link to the resources
type HrefObjectGovernanceResourcesLink struct {
...
type _HrefObjectGovernanceResourcesLink HrefObjectGovernanceResourcesLink
...
func NewHrefObjectGovernanceResourcesLink(href string) *HrefObjectGovernanceResourcesLink {
	this := HrefObjectGovernanceResourcesLink{}
	this.Href = href
	return &this
}
...
func (o HrefObjectGovernanceResourcesLink) MarshalJSON() ([]byte, error) {
...
func (o HrefObjectGovernanceResourcesLink) ToMap() (map[string]interface{}, error) {
...
func (o *HrefObjectGovernanceResourcesLink) UnmarshalJSON(data []byte) (err error) {
	...
	varHrefObjectGovernanceResourcesLink := _HrefObjectGovernanceResourcesLink{}

	err = json.Unmarshal(data, &varHrefObjectGovernanceResourcesLink)

	if err != nil {
		return err
	}

	*o = HrefObjectGovernanceResourcesLink(varHrefObjectGovernanceResourcesLink)
...
type NullableHrefObjectGovernanceResourcesLink struct {
	value *HrefObjectGovernanceResourcesLink
	isSet bool
}

func (v NullableHrefObjectGovernanceResourcesLink) Get() *HrefObjectGovernanceResourcesLink {
	return v.value
}

func (v *NullableHrefObjectGovernanceResourcesLink) Set(val *HrefObjectGovernanceResourcesLink) {
	v.value = val
	v.isSet = true
}

func (v NullableHrefObjectGovernanceResourcesLink) IsSet() bool {
	return v.isSet
}

func (v *NullableHrefObjectGovernanceResourcesLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHrefObjectGovernanceResourcesLink(val *HrefObjectGovernanceResourcesLink) *NullableHrefObjectGovernanceResourcesLink {
	return &NullableHrefObjectGovernanceResourcesLink{value: val, isSet: true}
}

func (v NullableHrefObjectGovernanceResourcesLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHrefObjectGovernanceResourcesLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
