...
type FeatureAPI interface {
	...
	*/
	UpdateFeatureLifecycle(ctx context.Context, featureId string, lifecycle FeatureLifecycle) ApiUpdateFeatureLifecycleRequest
...
![State transitions of a feature](../../../../../images/features/update-ssfeat-flowchart.png '#width=500px;')
	...
	@return ApiUpdateFeatureLifecycleRequest
*/
func (a *FeatureAPIService) UpdateFeatureLifecycle(ctx context.Context, featureId string, lifecycle FeatureLifecycle) ApiUpdateFeatureLifecycleRequest {
	return ApiUpdateFeatureLifecycleRequest{
		ApiService: a,
		ctx:        ctx,
		featureId:  featureId,
