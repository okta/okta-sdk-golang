...
// checks if the BehaviorRuleSettingsAnomalousDevice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BehaviorRuleSettingsAnomalousDevice{}
...
func (o BehaviorRuleSettingsAnomalousDevice) ToMap() (map[string]interface{}, error) {
...
func (o *BehaviorRuleSettingsAnomalousDevice) UnmarshalJSON(data []byte) (err error) {
	varBehaviorRuleSettingsAnomalousDevice := _BehaviorRuleSettingsAnomalousDevice{}

	err = json.Unmarshal(data, &varBehaviorRuleSettingsAnomalousDevice)
