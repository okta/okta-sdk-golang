...
type LinksQuestionsQuestion struct {
...
type _LinksQuestionsQuestion LinksQuestionsQuestion
...
func (o LinksQuestionsQuestion) MarshalJSON() ([]byte, error) {
...
func (o *LinksQuestionsQuestion) UnmarshalJSON(bytes []byte) (err error) {
	varLinksQuestionsQuestion := _LinksQuestionsQuestion{}

	err = json.Unmarshal(bytes, &varLinksQuestionsQuestion)
	if err == nil {
		*o = LinksQuestionsQuestion(varLinksQuestionsQuestion)
	} else {
		return err
	}
...
type NullableLinksQuestionsQuestion struct {
	value *LinksQuestionsQuestion
	isSet bool
}

func (v NullableLinksQuestionsQuestion) Get() *LinksQuestionsQuestion {
	return v.value
}

func (v *NullableLinksQuestionsQuestion) Set(val *LinksQuestionsQuestion) {
	v.value = val
	v.isSet = true
}

func (v NullableLinksQuestionsQuestion) IsSet() bool {
	return v.isSet
}

func (v *NullableLinksQuestionsQuestion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinksQuestionsQuestion(val *LinksQuestionsQuestion) *NullableLinksQuestionsQuestion {
	return &NullableLinksQuestionsQuestion{value: val, isSet: true}
}

func (v NullableLinksQuestionsQuestion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinksQuestionsQuestion) UnmarshalJSON(src []byte) error {
	v.isSet = true
