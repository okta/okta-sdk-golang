...
type _LinksFactorFactor LinksFactorFactor
...
func (o LinksFactorFactor) MarshalJSON() ([]byte, error) {
...
func (o *LinksFactorFactor) UnmarshalJSON(bytes []byte) (err error) {
	varLinksFactorFactor := _LinksFactorFactor{}

	err = json.Unmarshal(bytes, &varLinksFactorFactor)
	if err == nil {
		*o = LinksFactorFactor(varLinksFactorFactor)
	} else {
		return err
	}
...
type NullableLinksFactorFactor struct {
	value *LinksFactorFactor
	isSet bool
}

func (v NullableLinksFactorFactor) Get() *LinksFactorFactor {
	return v.value
}

func (v *NullableLinksFactorFactor) Set(val *LinksFactorFactor) {
	v.value = val
	v.isSet = true
}

func (v NullableLinksFactorFactor) IsSet() bool {
	return v.isSet
}

func (v *NullableLinksFactorFactor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinksFactorFactor(val *LinksFactorFactor) *NullableLinksFactorFactor {
	return &NullableLinksFactorFactor{value: val, isSet: true}
}

func (v NullableLinksFactorFactor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinksFactorFactor) UnmarshalJSON(src []byte) error {
	v.isSet = true
