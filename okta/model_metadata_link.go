...
type _MetadataLink MetadataLink
...
func (o MetadataLink) MarshalJSON() ([]byte, error) {
...
func (o MetadataLink) ToMap() (map[string]interface{}, error) {
...
func (o *MetadataLink) UnmarshalJSON(data []byte) (err error) {
	...
	varMetadataLink := _MetadataLink{}

	err = json.Unmarshal(data, &varMetadataLink)

	if err != nil {
		return err
	}

	*o = MetadataLink(varMetadataLink)
...
type NullableMetadataLink struct {
	value *MetadataLink
	isSet bool
}

func (v NullableMetadataLink) Get() *MetadataLink {
	return v.value
}

func (v *NullableMetadataLink) Set(val *MetadataLink) {
	v.value = val
	v.isSet = true
}

func (v NullableMetadataLink) IsSet() bool {
	return v.isSet
}

func (v *NullableMetadataLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetadataLink(val *MetadataLink) *NullableMetadataLink {
	return &NullableMetadataLink{value: val, isSet: true}
}

func (v NullableMetadataLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetadataLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
