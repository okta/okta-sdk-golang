...
// checks if the WsFederationApplicationSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WsFederationApplicationSettings{}
...
func (o WsFederationApplicationSettings) ToMap() (map[string]interface{}, error) {
...
func (o *WsFederationApplicationSettings) UnmarshalJSON(data []byte) (err error) {
	varWsFederationApplicationSettings := _WsFederationApplicationSettings{}

	err = json.Unmarshal(data, &varWsFederationApplicationSettings)
