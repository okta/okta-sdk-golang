...
// checks if the SsfTransmitterCaepSessionRevokedEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SsfTransmitterCaepSessionRevokedEvent{}

// SsfTransmitterCaepSessionRevokedEvent The session of the subject was revoked
...
type _SsfTransmitterCaepSessionRevokedEvent SsfTransmitterCaepSessionRevokedEvent
...
func NewSsfTransmitterCaepSessionRevokedEvent() *SsfTransmitterCaepSessionRevokedEvent {
	this := SsfTransmitterCaepSessionRevokedEvent{}
	return &this
}
...
func (o SsfTransmitterCaepSessionRevokedEvent) MarshalJSON() ([]byte, error) {
...
func (o SsfTransmitterCaepSessionRevokedEvent) ToMap() (map[string]interface{}, error) {
...
func (o *SsfTransmitterCaepSessionRevokedEvent) UnmarshalJSON(data []byte) (err error) {
	varSsfTransmitterCaepSessionRevokedEvent := _SsfTransmitterCaepSessionRevokedEvent{}

	err = json.Unmarshal(data, &varSsfTransmitterCaepSessionRevokedEvent)

	if err != nil {
		return err
	}

	*o = SsfTransmitterCaepSessionRevokedEvent(varSsfTransmitterCaepSessionRevokedEvent)
...
type NullableSsfTransmitterCaepSessionRevokedEvent struct {
	value *SsfTransmitterCaepSessionRevokedEvent
	isSet bool
}

func (v NullableSsfTransmitterCaepSessionRevokedEvent) Get() *SsfTransmitterCaepSessionRevokedEvent {
	return v.value
}

func (v *NullableSsfTransmitterCaepSessionRevokedEvent) Set(val *SsfTransmitterCaepSessionRevokedEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableSsfTransmitterCaepSessionRevokedEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableSsfTransmitterCaepSessionRevokedEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSsfTransmitterCaepSessionRevokedEvent(val *SsfTransmitterCaepSessionRevokedEvent) *NullableSsfTransmitterCaepSessionRevokedEvent {
	return &NullableSsfTransmitterCaepSessionRevokedEvent{value: val, isSet: true}
}

func (v NullableSsfTransmitterCaepSessionRevokedEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSsfTransmitterCaepSessionRevokedEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
