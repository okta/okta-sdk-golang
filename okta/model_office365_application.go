...
func (o Office365Application) ToMap() (map[string]interface{}, error) {
...
func (o *Office365Application) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varOffice365Application)
