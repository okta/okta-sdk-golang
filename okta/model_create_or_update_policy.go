...
type _CreateOrUpdatePolicy CreateOrUpdatePolicy
...
func (o *CreateOrUpdatePolicy) GetEmbedded() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *CreateOrUpdatePolicy) GetEmbeddedOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.Embedded) {
...
func (o *CreateOrUpdatePolicy) SetEmbedded(v map[string]interface{}) {
	o.Embedded = v
}
...
type NullableCreateOrUpdatePolicy struct {
	value *CreateOrUpdatePolicy
	isSet bool
}

func (v NullableCreateOrUpdatePolicy) Get() *CreateOrUpdatePolicy {
	return v.value
}

func (v *NullableCreateOrUpdatePolicy) Set(val *CreateOrUpdatePolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateOrUpdatePolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateOrUpdatePolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateOrUpdatePolicy(val *CreateOrUpdatePolicy) *NullableCreateOrUpdatePolicy {
	return &NullableCreateOrUpdatePolicy{value: val, isSet: true}
}

func (v NullableCreateOrUpdatePolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateOrUpdatePolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true
