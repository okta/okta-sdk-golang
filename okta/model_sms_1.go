...
// checks if the Sms1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Sms1{}
...
func (o Sms1) ToMap() (map[string]interface{}, error) {
...
func (o *Sms1) UnmarshalJSON(data []byte) (err error) {
	varSms1 := _Sms1{}

	err = json.Unmarshal(data, &varSms1)
