...
// checks if the AccessPolicyLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessPolicyLink{}

// AccessPolicyLink Link to the app access policy resource
...
type _AccessPolicyLink AccessPolicyLink
...
func (o AccessPolicyLink) MarshalJSON() ([]byte, error) {
...
func (o AccessPolicyLink) ToMap() (map[string]interface{}, error) {
...
func (o *AccessPolicyLink) UnmarshalJSON(data []byte) (err error) {
	...
	varAccessPolicyLink := _AccessPolicyLink{}

	err = json.Unmarshal(data, &varAccessPolicyLink)

	if err != nil {
		return err
	}

	*o = AccessPolicyLink(varAccessPolicyLink)
...
type NullableAccessPolicyLink struct {
	value *AccessPolicyLink
	isSet bool
}

func (v NullableAccessPolicyLink) Get() *AccessPolicyLink {
	return v.value
}

func (v *NullableAccessPolicyLink) Set(val *AccessPolicyLink) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessPolicyLink) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessPolicyLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessPolicyLink(val *AccessPolicyLink) *NullableAccessPolicyLink {
	return &NullableAccessPolicyLink{value: val, isSet: true}
}

func (v NullableAccessPolicyLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessPolicyLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
