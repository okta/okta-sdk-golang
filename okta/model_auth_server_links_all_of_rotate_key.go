...
type AuthServerLinksAllOfRotateKey struct {
...
type _AuthServerLinksAllOfRotateKey AuthServerLinksAllOfRotateKey
...
func NewAuthServerLinksAllOfRotateKey(href string) *AuthServerLinksAllOfRotateKey {
	this := AuthServerLinksAllOfRotateKey{}
	this.Href = href
	return &this
}
...
func (o AuthServerLinksAllOfRotateKey) MarshalJSON() ([]byte, error) {
...
func (o *AuthServerLinksAllOfRotateKey) UnmarshalJSON(bytes []byte) (err error) {
	varAuthServerLinksAllOfRotateKey := _AuthServerLinksAllOfRotateKey{}

	err = json.Unmarshal(bytes, &varAuthServerLinksAllOfRotateKey)
	if err == nil {
		*o = AuthServerLinksAllOfRotateKey(varAuthServerLinksAllOfRotateKey)
	} else {
		return err
	}
...
type NullableAuthServerLinksAllOfRotateKey struct {
	value *AuthServerLinksAllOfRotateKey
	isSet bool
}

func (v NullableAuthServerLinksAllOfRotateKey) Get() *AuthServerLinksAllOfRotateKey {
	return v.value
}

func (v *NullableAuthServerLinksAllOfRotateKey) Set(val *AuthServerLinksAllOfRotateKey) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthServerLinksAllOfRotateKey) IsSet() bool {
	return v.isSet
}

func (v *NullableAuthServerLinksAllOfRotateKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuthServerLinksAllOfRotateKey(val *AuthServerLinksAllOfRotateKey) *NullableAuthServerLinksAllOfRotateKey {
	return &NullableAuthServerLinksAllOfRotateKey{value: val, isSet: true}
}

func (v NullableAuthServerLinksAllOfRotateKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuthServerLinksAllOfRotateKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
