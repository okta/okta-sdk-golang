...
// checks if the HrefObjectAssigneeLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HrefObjectAssigneeLink{}

// HrefObjectAssigneeLink Link to the assignee resource
type HrefObjectAssigneeLink struct {
...
type _HrefObjectAssigneeLink HrefObjectAssigneeLink
...
func (o HrefObjectAssigneeLink) MarshalJSON() ([]byte, error) {
...
func (o HrefObjectAssigneeLink) ToMap() (map[string]interface{}, error) {
...
func (o *HrefObjectAssigneeLink) UnmarshalJSON(data []byte) (err error) {
	...
	varHrefObjectAssigneeLink := _HrefObjectAssigneeLink{}

	err = json.Unmarshal(data, &varHrefObjectAssigneeLink)

	if err != nil {
		return err
	}

	*o = HrefObjectAssigneeLink(varHrefObjectAssigneeLink)
...
type NullableHrefObjectAssigneeLink struct {
	value *HrefObjectAssigneeLink
	isSet bool
}

func (v NullableHrefObjectAssigneeLink) Get() *HrefObjectAssigneeLink {
	return v.value
}

func (v *NullableHrefObjectAssigneeLink) Set(val *HrefObjectAssigneeLink) {
	v.value = val
	v.isSet = true
}

func (v NullableHrefObjectAssigneeLink) IsSet() bool {
	return v.isSet
}

func (v *NullableHrefObjectAssigneeLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHrefObjectAssigneeLink(val *HrefObjectAssigneeLink) *NullableHrefObjectAssigneeLink {
	return &NullableHrefObjectAssigneeLink{value: val, isSet: true}
}

func (v NullableHrefObjectAssigneeLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHrefObjectAssigneeLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
