...
type AppUser struct {
	...
	SyncState     *AppUserSyncState `json:"syncState,omitempty"`
	...
	Links                LinksAppAndUser                   `json:"_links"`
...
// SetSyncState gets a reference to the given AppUserSyncState and assigns it to the SyncState field.
