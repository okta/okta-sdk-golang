...
type AuthenticatorMethodWebAuthnAllOfSettings struct {
	...
	Attachment           *WebAuthnAttachment   `json:"attachment,omitempty"`
...
// SetAttachment gets a reference to the given WebAuthnAttachment and assigns it to the Attachment field.
