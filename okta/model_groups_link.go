...
func (o GroupsLink) MarshalJSON() ([]byte, error) {
...
func (o GroupsLink) ToMap() (map[string]interface{}, error) {
...
func (o *GroupsLink) UnmarshalJSON(data []byte) (err error) {
	...
	varGroupsLink := _GroupsLink{}

	err = json.Unmarshal(data, &varGroupsLink)

	if err != nil {
		return err
	}

	*o = GroupsLink(varGroupsLink)
...
type NullableGroupsLink struct {
	value *GroupsLink
	isSet bool
}

func (v NullableGroupsLink) Get() *GroupsLink {
	return v.value
}

func (v *NullableGroupsLink) Set(val *GroupsLink) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupsLink) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupsLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupsLink(val *GroupsLink) *NullableGroupsLink {
	return &NullableGroupsLink{value: val, isSet: true}
}

func (v NullableGroupsLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupsLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
