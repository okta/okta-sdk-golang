...
// checks if the InboundProvisioningApplicationFeature type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InboundProvisioningApplicationFeature{}
...
func (o InboundProvisioningApplicationFeature) ToMap() (map[string]interface{}, error) {
...
func (o *InboundProvisioningApplicationFeature) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varInboundProvisioningApplicationFeatureWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varInboundProvisioningApplicationFeature)
	if err == nil {
