...
// checks if the ZoomUsApplicationSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoomUsApplicationSettings{}
...
func (o ZoomUsApplicationSettings) ToMap() (map[string]interface{}, error) {
...
func (o *ZoomUsApplicationSettings) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varZoomUsApplicationSettings)
