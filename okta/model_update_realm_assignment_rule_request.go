...
// UpdateRealmAssignmentRuleRequest struct for UpdateRealmAssignmentRuleRequest
type UpdateRealmAssignmentRuleRequest struct {
...
type _UpdateRealmAssignmentRuleRequest UpdateRealmAssignmentRuleRequest
...
func NewUpdateRealmAssignmentRuleRequest() *UpdateRealmAssignmentRuleRequest {
	this := UpdateRealmAssignmentRuleRequest{}
	return &this
}
...
func (o UpdateRealmAssignmentRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o *UpdateRealmAssignmentRuleRequest) UnmarshalJSON(bytes []byte) (err error) {
	varUpdateRealmAssignmentRuleRequest := _UpdateRealmAssignmentRuleRequest{}

	err = json.Unmarshal(bytes, &varUpdateRealmAssignmentRuleRequest)
	if err == nil {
		*o = UpdateRealmAssignmentRuleRequest(varUpdateRealmAssignmentRuleRequest)
	} else {
		return err
	}
...
type NullableUpdateRealmAssignmentRuleRequest struct {
	value *UpdateRealmAssignmentRuleRequest
	isSet bool
}

func (v NullableUpdateRealmAssignmentRuleRequest) Get() *UpdateRealmAssignmentRuleRequest {
	return v.value
}

func (v *NullableUpdateRealmAssignmentRuleRequest) Set(val *UpdateRealmAssignmentRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateRealmAssignmentRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateRealmAssignmentRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateRealmAssignmentRuleRequest(val *UpdateRealmAssignmentRuleRequest) *NullableUpdateRealmAssignmentRuleRequest {
	return &NullableUpdateRealmAssignmentRuleRequest{value: val, isSet: true}
}

func (v NullableUpdateRealmAssignmentRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateRealmAssignmentRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
