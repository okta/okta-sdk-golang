...
type DeviceAssuranceMacOSPlatformAllOfDiskEncryptionType struct {
	Include              []DiskEncryptionTypeDesktop `json:"include,omitempty"`
...
func (o *DeviceAssuranceMacOSPlatformAllOfDiskEncryptionType) GetInclude() []DiskEncryptionTypeDesktop {
	if o == nil || o.Include == nil {
		var ret []DiskEncryptionTypeDesktop
		return ret
	}
	return o.Include
}
...
// SetInclude gets a reference to the given []DiskEncryptionTypeDesktop and assigns it to the Include field.
