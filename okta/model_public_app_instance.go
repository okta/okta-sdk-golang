...
// checks if the PublicAppInstance type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PublicAppInstance{}

// PublicAppInstance App instance list item returned by /search endpoint.
type PublicAppInstance struct {
	...
	// App type categorization tags used by the Apps list page facets. Values align with the [`/apps/types`](/openapi/okta-management/management/tag/Application/#tag/Application/operation/listAppTypeUsage) taxonomy (for example, `SAML`, `OIDC`, `PROVISIONING`, `UNIVERSAL_LOGOUT`). Multi-valued because an app can belong to several buckets.
...
type _PublicAppInstance PublicAppInstance
...
func (o PublicAppInstance) MarshalJSON() ([]byte, error) {
...
func (o PublicAppInstance) ToMap() (map[string]interface{}, error) {
...
func (o *PublicAppInstance) UnmarshalJSON(data []byte) (err error) {
	...
	varPublicAppInstance := _PublicAppInstance{}

	err = json.Unmarshal(data, &varPublicAppInstance)

	if err != nil {
		return err
	}

	*o = PublicAppInstance(varPublicAppInstance)
...
type NullablePublicAppInstance struct {
	value *PublicAppInstance
	isSet bool
}

func (v NullablePublicAppInstance) Get() *PublicAppInstance {
	return v.value
}

func (v *NullablePublicAppInstance) Set(val *PublicAppInstance) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicAppInstance) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicAppInstance) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicAppInstance(val *PublicAppInstance) *NullablePublicAppInstance {
	return &NullablePublicAppInstance{value: val, isSet: true}
}

func (v NullablePublicAppInstance) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicAppInstance) UnmarshalJSON(src []byte) error {
	v.isSet = true
