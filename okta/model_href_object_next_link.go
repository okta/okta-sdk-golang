...
// checks if the HrefObjectNextLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HrefObjectNextLink{}

// HrefObjectNextLink Link to the next resource
type HrefObjectNextLink struct {
...
type _HrefObjectNextLink HrefObjectNextLink
...
func (o HrefObjectNextLink) MarshalJSON() ([]byte, error) {
...
func (o HrefObjectNextLink) ToMap() (map[string]interface{}, error) {
...
func (o *HrefObjectNextLink) UnmarshalJSON(data []byte) (err error) {
	...
	varHrefObjectNextLink := _HrefObjectNextLink{}

	err = json.Unmarshal(data, &varHrefObjectNextLink)

	if err != nil {
		return err
	}

	*o = HrefObjectNextLink(varHrefObjectNextLink)
...
type NullableHrefObjectNextLink struct {
	value *HrefObjectNextLink
	isSet bool
}

func (v NullableHrefObjectNextLink) Get() *HrefObjectNextLink {
	return v.value
}

func (v *NullableHrefObjectNextLink) Set(val *HrefObjectNextLink) {
	v.value = val
	v.isSet = true
}

func (v NullableHrefObjectNextLink) IsSet() bool {
	return v.isSet
}

func (v *NullableHrefObjectNextLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHrefObjectNextLink(val *HrefObjectNextLink) *NullableHrefObjectNextLink {
	return &NullableHrefObjectNextLink{value: val, isSet: true}
}

func (v NullableHrefObjectNextLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHrefObjectNextLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
