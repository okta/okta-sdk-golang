...
type DomainLinksAllOfCertificate struct {
...
type _DomainLinksAllOfCertificate DomainLinksAllOfCertificate
...
func NewDomainLinksAllOfCertificate(href string) *DomainLinksAllOfCertificate {
	this := DomainLinksAllOfCertificate{}
	this.Href = href
	return &this
}
...
func (o DomainLinksAllOfCertificate) MarshalJSON() ([]byte, error) {
...
func (o *DomainLinksAllOfCertificate) UnmarshalJSON(bytes []byte) (err error) {
	varDomainLinksAllOfCertificate := _DomainLinksAllOfCertificate{}

	err = json.Unmarshal(bytes, &varDomainLinksAllOfCertificate)
	if err == nil {
		*o = DomainLinksAllOfCertificate(varDomainLinksAllOfCertificate)
	} else {
		return err
	}
...
type NullableDomainLinksAllOfCertificate struct {
	value *DomainLinksAllOfCertificate
	isSet bool
}

func (v NullableDomainLinksAllOfCertificate) Get() *DomainLinksAllOfCertificate {
	return v.value
}

func (v *NullableDomainLinksAllOfCertificate) Set(val *DomainLinksAllOfCertificate) {
	v.value = val
	v.isSet = true
}

func (v NullableDomainLinksAllOfCertificate) IsSet() bool {
	return v.isSet
}

func (v *NullableDomainLinksAllOfCertificate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDomainLinksAllOfCertificate(val *DomainLinksAllOfCertificate) *NullableDomainLinksAllOfCertificate {
	return &NullableDomainLinksAllOfCertificate{value: val, isSet: true}
}

func (v NullableDomainLinksAllOfCertificate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDomainLinksAllOfCertificate) UnmarshalJSON(src []byte) error {
	v.isSet = true
