...
type RoleCResourceSetResourceAPI interface {
	...
	*/
	...
	// AddResourceSetResourcesExecute executes the request
	//  @return ResourceSet
	...
	*/
	...
	// GetResourceSetResourceExecute executes the request
	//  @return ResourceSetResource
	...
	*/
	...
	// ReplaceResourceSetResourceExecute executes the request
	//  @return ResourceSetResource
	ReplaceResourceSetResourceExecute(r ApiReplaceResourceSetResourceRequest) (*ResourceSetResource, *APIResponse, error)
}

// RoleCResourceSetResourceAPIService RoleCResourceSetResourceAPI service
...
func (r ApiAddResourceSetResourceRequest) Execute() (*ResourceSetResource, *APIResponse, error) {
...
func (a *RoleCResourceSetResourceAPIService) AddResourceSetResourceExecute(r ApiAddResourceSetResourceRequest) (*ResourceSetResource, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RoleCResourceSetResourceAPIService.AddResourceSetResource")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/iam/resource-sets/{resourceSetIdOrLabel}/resources"
...
func (r ApiAddResourceSetResourcesRequest) Execute() (*ResourceSet, *APIResponse, error) {
	return r.ApiService.AddResourceSetResourcesExecute(r)
}
...
func (a *RoleCResourceSetResourceAPIService) AddResourceSetResourcesExecute(r ApiAddResourceSetResourcesRequest) (*ResourceSet, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RoleCResourceSetResourceAPIService.AddResourceSetResources")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// Execute executes the request
func (a *RoleCResourceSetResourceAPIService) DeleteResourceSetResourceExecute(r ApiDeleteResourceSetResourceRequest) (*APIResponse, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RoleCResourceSetResourceAPIService.DeleteResourceSetResource")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/iam/resource-sets/{resourceSetIdOrLabel}/resources/{resourceId}"
	localVarPath = strings.Replace(localVarPath, "{"+"resourceSetIdOrLabel"+"}", url.PathEscape(parameterToString(r.resourceSetIdOrLabel, "")), -1)
...
func (r ApiGetResourceSetResourceRequest) Execute() (*ResourceSetResource, *APIResponse, error) {
	return r.ApiService.GetResourceSetResourceExecute(r)
}
...
func (a *RoleCResourceSetResourceAPIService) GetResourceSetResourceExecute(r ApiGetResourceSetResourceRequest) (*ResourceSetResource, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RoleCResourceSetResourceAPIService.GetResourceSetResource")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *RoleCResourceSetResourceAPIService) ListResourceSetResourcesExecute(r ApiListResourceSetResourcesRequest) (*ResourceSetResources, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RoleCResourceSetResourceAPIService.ListResourceSetResources")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiReplaceResourceSetResourceRequest) ResourceSetResourcePutRequest(resourceSetResourcePutRequest ResourceSetResourcePutRequest) ApiReplaceResourceSetResourceRequest {
	r.resourceSetResourcePutRequest = &resourceSetResourcePutRequest
	return r
}

func (r ApiReplaceResourceSetResourceRequest) Execute() (*ResourceSetResource, *APIResponse, error) {
	return r.ApiService.ReplaceResourceSetResourceExecute(r)
}
...
func (a *RoleCResourceSetResourceAPIService) ReplaceResourceSetResourceExecute(r ApiReplaceResourceSetResourceRequest) (*ResourceSetResource, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RoleCResourceSetResourceAPIService.ReplaceResourceSetResource")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.resourceSetResourcePutRequest == nil {
		return localVarReturnValue, nil, reportError("resourceSetResourcePutRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.resourceSetResourcePutRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiToken"]; ok {
