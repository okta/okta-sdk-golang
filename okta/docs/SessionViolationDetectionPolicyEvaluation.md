# SessionViolationDetectionPolicyEvaluation

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Enabled** | Pointer to **bool** | When true, the sign-on policies of the session are evaluated | [optional] 

## Methods

### NewSessionViolationDetectionPolicyEvaluation
...
### NewSessionViolationDetectionPolicyEvaluationWithDefaults
