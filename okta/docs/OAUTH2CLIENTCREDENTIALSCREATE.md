...
### NewOAUTH2CLIENTCREDENTIALSCREATE

`func NewOAUTH2CLIENTCREDENTIALSCREATE(clientId string, clientSecret string, scopes []string, tokenEndpoint string, tokenEndpointAuthMethod string, ) *OAUTH2CLIENTCREDENTIALSCREATE`
...
### NewOAUTH2CLIENTCREDENTIALSCREATEWithDefaults
