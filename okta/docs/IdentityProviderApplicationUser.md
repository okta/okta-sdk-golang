...
`func (o *IdentityProviderApplicationUser) GetProfile() map[string]interface{}`

GetProfile returns the Profile field if non-nil, zero value otherwise.

### GetProfileOk

`func (o *IdentityProviderApplicationUser) GetProfileOk() (*map[string]interface{}, bool)`
...
`func (o *IdentityProviderApplicationUser) SetProfile(v map[string]interface{})`
