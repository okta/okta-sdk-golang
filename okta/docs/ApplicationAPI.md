...
func main() {
	...
	filter := "status eq "ACTIVE"" // string | Filters apps with a supported expression for a subset of properties. Filtering supports the following limited number of properties: `id`, `status`, `credentials.signing.kid`, `settings.slo.enabled`, `name`, or `cimd.client.linkable`. See [Filter](https://developer.okta.com/docs/api/#filter). (optional)
 ...
 **filter** | **string** | Filters apps with a supported expression for a subset of properties. Filtering supports the following limited number of properties: &#x60;id&#x60;, &#x60;status&#x60;, &#x60;credentials.signing.kid&#x60;, &#x60;settings.slo.enabled&#x60;, &#x60;name&#x60;, or &#x60;cimd.client.linkable&#x60;. See [Filter](https://developer.okta.com/docs/api/#filter). | 
