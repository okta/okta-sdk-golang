...
**RuleOperation** | Pointer to [**OperationResponseRuleOperation**](OperationResponseRuleOperation.md) |  | [optional] 
...
GetRuleOperation returns the RuleOperation field if non-nil, zero value otherwise.

### GetRuleOperationOk

`func (o *OperationResponse) GetRuleOperationOk() (*OperationResponseRuleOperation, bool)`

GetRuleOperationOk returns a tuple with the RuleOperation field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetRuleOperation sets RuleOperation field to given value.
