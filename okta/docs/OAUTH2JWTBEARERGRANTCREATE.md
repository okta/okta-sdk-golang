...
### NewOAUTH2JWTBEARERGRANTCREATE

`func NewOAUTH2JWTBEARERGRANTCREATE(audience string, clientId string, issuer string, keyId string, privateKey string, scopes []string, signingAlgorithm string, subject string, tokenEndpoint string, ) *OAUTH2JWTBEARERGRANTCREATE`
...
### NewOAUTH2JWTBEARERGRANTCREATEWithDefaults
