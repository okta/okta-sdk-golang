...
**OsVersionConstraints** | Pointer to [**[]OSVersionConstraint**](OSVersionConstraint.md) | Specifies the OS version requirements. Each requirement must correspond to a major version. If a requirement isn&#39;t specified for a major version, then devices on that major version will bypass the requirement.  There are two types of OS version requirements: * **Static**: It doesn&#39;t change until you update the policy. It is specified with &#x60;majorVersionConstraint&#x60; and &#x60;minimum&#x60; properties. * **Dynamic**: It is relative to the latest major OS release and security patch. It is specified with &#x60;majorVersionConstraint&#x60; and &#x60;dynamicVersionRequirement&#x60; properties.  &gt; **Note:** You can&#39;t specify both &#x60;osVersion.minimum&#x60; and &#x60;osVersionConstraints&#x60; properties at the same time.  | [optional] 
