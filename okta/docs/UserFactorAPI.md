...
func main() {
	...
	expand := "expand_example" // string | Embeds the [user](/openapi/okta-management/management/tags/user) resource if the YubiKey token is assigned to a user and `expand` is set to `user` (optional)
 ...
 **expand** | **string** | Embeds the [user](/openapi/okta-management/management/tags/user) resource if the YubiKey token is assigned to a user and &#x60;expand&#x60; is set to &#x60;user&#x60; | 
