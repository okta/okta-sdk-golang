...
------------ | ------------- | ------------- | -------------
**Created** | **time.Time** | Timestamp when the App User object was created | [readonly] 
...
**LastUpdated** | **time.Time** | Timestamp when App User was last updated | [readonly] 
...
**SyncState** | Pointer to [**AppUserSyncState**](AppUserSyncState.md) |  | [optional] 
