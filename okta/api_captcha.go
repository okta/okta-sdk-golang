...
// Execute executes the request
func (a *CAPTCHAAPIService) DeleteOrgCaptchaSettingsExecute(r ApiDeleteOrgCaptchaSettingsRequest) (*APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath := localBasePath + "/api/v1/org/captcha"
...
func (r ApiGetOrgCaptchaSettingsRequest) Execute() (*OrgCAPTCHASettings, *APIResponse, error) {
...
func (r ApiReplacesOrgCaptchaSettingsRequest) OrgCAPTCHASettings(orgCAPTCHASettings OrgCAPTCHASettings) ApiReplacesOrgCaptchaSettingsRequest {
	r.orgCAPTCHASettings = &orgCAPTCHASettings
	return r
}

func (r ApiReplacesOrgCaptchaSettingsRequest) Execute() (*OrgCAPTCHASettings, *APIResponse, error) {
...
func (a *CAPTCHAAPIService) ReplacesOrgCaptchaSettingsExecute(r ApiReplacesOrgCaptchaSettingsRequest) (*OrgCAPTCHASettings, *APIResponse, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.orgCAPTCHASettings == nil {
		return localVarReturnValue, nil, reportError("orgCAPTCHASettings is required and must be specified")
	}
