...
type EmailDomainDNSRecord struct {
	...
	RecordType           *EmailDomainDNSRecordType `json:"recordType,omitempty"`
...
func (o *EmailDomainDNSRecord) GetRecordType() EmailDomainDNSRecordType {
	if o == nil || o.RecordType == nil {
		var ret EmailDomainDNSRecordType
		return ret
	}
	return *o.RecordType
}
...
// SetRecordType gets a reference to the given EmailDomainDNSRecordType and assigns it to the RecordType field.
