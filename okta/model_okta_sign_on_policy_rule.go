...
// checks if the OktaSignOnPolicyRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OktaSignOnPolicyRule{}
...
func (o OktaSignOnPolicyRule) ToMap() (map[string]interface{}, error) {
...
func (o *OktaSignOnPolicyRule) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varOktaSignOnPolicyRuleWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varOktaSignOnPolicyRule)
	if err == nil {
