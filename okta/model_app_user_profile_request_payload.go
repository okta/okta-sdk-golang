...
// checks if the AppUserProfileRequestPayload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppUserProfileRequestPayload{}
...
func (o AppUserProfileRequestPayload) ToMap() (map[string]interface{}, error) {
...
func (o *AppUserProfileRequestPayload) UnmarshalJSON(data []byte) (err error) {
	varAppUserProfileRequestPayload := _AppUserProfileRequestPayload{}

	err = json.Unmarshal(data, &varAppUserProfileRequestPayload)
