...
// TrendMicroApexOneServiceApplication Schema for Trend Micro Apex One as a Service app  To create a Trend Micro Apex One as a Service app, use the [Create an Application](/openapi/okta-management/management/tag/Application/#tag/Application/operation/createApplication) request with the required parameters in the request body from the Trend Micro Apex One as a Service app schema. > **Note:** The Trend Micro Apex One as a Service app only supports `SAML_2_0` sign-on mode.
