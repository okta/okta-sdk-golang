...
func (m *AppUserResource) UpdateApplicationUser(appId string, userId string, body AppUser)  *AppUser {
...
func (m *AppUserResource) DeleteApplicationUser(appId string, userId string)  {
