...
type DeviceAssuranceAndroidPlatformAllOfDiskEncryptionType struct {
	Include              []DiskEncryptionTypeAndroid `json:"include,omitempty"`
...
func (o *DeviceAssuranceAndroidPlatformAllOfDiskEncryptionType) GetInclude() []DiskEncryptionTypeAndroid {
	if o == nil || o.Include == nil {
		var ret []DiskEncryptionTypeAndroid
		return ret
	}
	return o.Include
}
...
// SetInclude gets a reference to the given []DiskEncryptionTypeAndroid and assigns it to the Include field.
