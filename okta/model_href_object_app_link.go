...
// checks if the HrefObjectAppLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HrefObjectAppLink{}

// HrefObjectAppLink Link to the app resource
...
func (o HrefObjectAppLink) ToMap() (map[string]interface{}, error) {
...
func (o *HrefObjectAppLink) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHrefObjectAppLink)
