...
// checks if the AuthenticatorKeyGoogleOtp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthenticatorKeyGoogleOtp{}
...
func (o AuthenticatorKeyGoogleOtp) ToMap() (map[string]interface{}, error) {
...
func (o *AuthenticatorKeyGoogleOtp) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAuthenticatorKeyGoogleOtpWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varAuthenticatorKeyGoogleOtp)
	if err == nil {
