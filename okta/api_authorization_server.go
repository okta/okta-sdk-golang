...
type AuthorizationServerApi interface {
	...
	*/
	...
	/*
		CreateAssociatedServers Create the Associated Authorization Servers
...
Creates the trusted relationships between the given authorization server and other authorization servers
	...
	@return ApiCreateAssociatedServersRequest
*/
func (a *AuthorizationServerApiService) CreateAssociatedServers(ctx context.Context, authServerId string) ApiCreateAssociatedServersRequest {
	return ApiCreateAssociatedServersRequest{
		ApiService:   a,
		ctx:          ctx,
		authServerId: authServerId,
...
//
//	@return []AuthorizationServer
func (a *AuthorizationServerApiService) CreateAssociatedServersExecute(r ApiCreateAssociatedServersRequest) ([]AuthorizationServer, *APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthorizationServerApiService.CreateAssociatedServers")
	if err != nil {
...
Deletes an associated authorization server
	...
	@return ApiDeleteAssociatedServerRequest
*/
func (a *AuthorizationServerApiService) DeleteAssociatedServer(ctx context.Context, authServerId string, associatedServerId string) ApiDeleteAssociatedServerRequest {
	return ApiDeleteAssociatedServerRequest{
		ApiService:         a,
		ctx:                ctx,
		authServerId:       authServerId,
...
// Execute executes the request
func (a *AuthorizationServerApiService) DeleteAssociatedServerExecute(r ApiDeleteAssociatedServerRequest) (*APIResponse, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthorizationServerApiService.DeleteAssociatedServer")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
Lists all associated authorization servers by trusted type for the given `authServerId`
	...
	@return ApiListAssociatedServersByTrustedTypeRequest
*/
func (a *AuthorizationServerApiService) ListAssociatedServersByTrustedType(ctx context.Context, authServerId string) ApiListAssociatedServersByTrustedTypeRequest {
	return ApiListAssociatedServersByTrustedTypeRequest{
		ApiService:   a,
		ctx:          ctx,
		authServerId: authServerId,
...
//
//	@return []AuthorizationServer
func (a *AuthorizationServerApiService) ListAssociatedServersByTrustedTypeExecute(r ApiListAssociatedServersByTrustedTypeRequest) ([]AuthorizationServer, *APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthorizationServerApiService.ListAssociatedServersByTrustedType")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
