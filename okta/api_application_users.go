...
func (r ApiAssignUserToApplicationRequest) AppUser(appUser AppUserAssignRequest) ApiAssignUserToApplicationRequest {
	r.appUser = &appUser
	return r
}
...
func (r ApiUpdateApplicationUserRequest) AppUser(appUser AppUserUpdateRequest) ApiUpdateApplicationUserRequest {
	r.appUser = &appUser
	return r
}
