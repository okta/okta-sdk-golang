...
// OAuth2ScopeConsentGrantLinksAllOfApp Link to app
type OAuth2ScopeConsentGrantLinksAllOfApp struct {
...
type _OAuth2ScopeConsentGrantLinksAllOfApp OAuth2ScopeConsentGrantLinksAllOfApp
...
func NewOAuth2ScopeConsentGrantLinksAllOfApp(href string) *OAuth2ScopeConsentGrantLinksAllOfApp {
	this := OAuth2ScopeConsentGrantLinksAllOfApp{}
	this.Href = href
	return &this
}
...
func (o OAuth2ScopeConsentGrantLinksAllOfApp) MarshalJSON() ([]byte, error) {
...
func (o *OAuth2ScopeConsentGrantLinksAllOfApp) UnmarshalJSON(bytes []byte) (err error) {
	varOAuth2ScopeConsentGrantLinksAllOfApp := _OAuth2ScopeConsentGrantLinksAllOfApp{}

	err = json.Unmarshal(bytes, &varOAuth2ScopeConsentGrantLinksAllOfApp)
	if err == nil {
		*o = OAuth2ScopeConsentGrantLinksAllOfApp(varOAuth2ScopeConsentGrantLinksAllOfApp)
	} else {
		return err
	}
...
type NullableOAuth2ScopeConsentGrantLinksAllOfApp struct {
	value *OAuth2ScopeConsentGrantLinksAllOfApp
	isSet bool
}

func (v NullableOAuth2ScopeConsentGrantLinksAllOfApp) Get() *OAuth2ScopeConsentGrantLinksAllOfApp {
	return v.value
}

func (v *NullableOAuth2ScopeConsentGrantLinksAllOfApp) Set(val *OAuth2ScopeConsentGrantLinksAllOfApp) {
	v.value = val
	v.isSet = true
}

func (v NullableOAuth2ScopeConsentGrantLinksAllOfApp) IsSet() bool {
	return v.isSet
}

func (v *NullableOAuth2ScopeConsentGrantLinksAllOfApp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOAuth2ScopeConsentGrantLinksAllOfApp(val *OAuth2ScopeConsentGrantLinksAllOfApp) *NullableOAuth2ScopeConsentGrantLinksAllOfApp {
	return &NullableOAuth2ScopeConsentGrantLinksAllOfApp{value: val, isSet: true}
}

func (v NullableOAuth2ScopeConsentGrantLinksAllOfApp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOAuth2ScopeConsentGrantLinksAllOfApp) UnmarshalJSON(src []byte) error {
	v.isSet = true
