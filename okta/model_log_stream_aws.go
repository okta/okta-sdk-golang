...
func NewLogStreamAws(settings LogStreamSettingsAws, created time.Time, id string, lastUpdated time.Time, name string, status string, type_ LogStreamType, links LogStreamLinksSelfAndLifecycle) *LogStreamAws {
	this := LogStreamAws{}
