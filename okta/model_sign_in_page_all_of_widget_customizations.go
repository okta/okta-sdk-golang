...
type SignInPageAllOfWidgetCustomizations struct {
	...
	WidgetGeneration                        *WidgetGeneration `json:"widgetGeneration,omitempty"`
...
// SetWidgetGeneration gets a reference to the given WidgetGeneration and assigns it to the WidgetGeneration field.
