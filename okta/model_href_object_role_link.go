...
// checks if the HrefObjectRoleLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HrefObjectRoleLink{}

// HrefObjectRoleLink Link to the role resource
type HrefObjectRoleLink struct {
...
type _HrefObjectRoleLink HrefObjectRoleLink
...
func (o HrefObjectRoleLink) MarshalJSON() ([]byte, error) {
...
func (o HrefObjectRoleLink) ToMap() (map[string]interface{}, error) {
...
func (o *HrefObjectRoleLink) UnmarshalJSON(data []byte) (err error) {
	...
	varHrefObjectRoleLink := _HrefObjectRoleLink{}

	err = json.Unmarshal(data, &varHrefObjectRoleLink)

	if err != nil {
		return err
	}

	*o = HrefObjectRoleLink(varHrefObjectRoleLink)
...
type NullableHrefObjectRoleLink struct {
	value *HrefObjectRoleLink
	isSet bool
}

func (v NullableHrefObjectRoleLink) Get() *HrefObjectRoleLink {
	return v.value
}

func (v *NullableHrefObjectRoleLink) Set(val *HrefObjectRoleLink) {
	v.value = val
	v.isSet = true
}

func (v NullableHrefObjectRoleLink) IsSet() bool {
	return v.isSet
}

func (v *NullableHrefObjectRoleLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHrefObjectRoleLink(val *HrefObjectRoleLink) *NullableHrefObjectRoleLink {
	return &NullableHrefObjectRoleLink{value: val, isSet: true}
}

func (v NullableHrefObjectRoleLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHrefObjectRoleLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
