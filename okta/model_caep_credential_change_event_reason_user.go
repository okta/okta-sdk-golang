...
// checks if the CaepCredentialChangeEventReasonUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CaepCredentialChangeEventReasonUser{}
...
func (o CaepCredentialChangeEventReasonUser) ToMap() (map[string]interface{}, error) {
...
func (o *CaepCredentialChangeEventReasonUser) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCaepCredentialChangeEventReasonUser)
