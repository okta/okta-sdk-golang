...
// checks if the HrefObjectBindingLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HrefObjectBindingLink{}

// HrefObjectBindingLink Link to the binding resource
type HrefObjectBindingLink struct {
...
type _HrefObjectBindingLink HrefObjectBindingLink
...
func (o HrefObjectBindingLink) MarshalJSON() ([]byte, error) {
...
func (o HrefObjectBindingLink) ToMap() (map[string]interface{}, error) {
...
func (o *HrefObjectBindingLink) UnmarshalJSON(data []byte) (err error) {
	...
	varHrefObjectBindingLink := _HrefObjectBindingLink{}

	err = json.Unmarshal(data, &varHrefObjectBindingLink)

	if err != nil {
		return err
	}

	*o = HrefObjectBindingLink(varHrefObjectBindingLink)
...
type NullableHrefObjectBindingLink struct {
	value *HrefObjectBindingLink
	isSet bool
}

func (v NullableHrefObjectBindingLink) Get() *HrefObjectBindingLink {
	return v.value
}

func (v *NullableHrefObjectBindingLink) Set(val *HrefObjectBindingLink) {
	v.value = val
	v.isSet = true
}

func (v NullableHrefObjectBindingLink) IsSet() bool {
	return v.isSet
}

func (v *NullableHrefObjectBindingLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHrefObjectBindingLink(val *HrefObjectBindingLink) *NullableHrefObjectBindingLink {
	return &NullableHrefObjectBindingLink{value: val, isSet: true}
}

func (v NullableHrefObjectBindingLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHrefObjectBindingLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
