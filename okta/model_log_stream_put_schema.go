...
// checks if the LogStreamPutSchema type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LogStreamPutSchema{}
...
func (o LogStreamPutSchema) ToMap() (map[string]interface{}, error) {
...
func (o *LogStreamPutSchema) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varLogStreamPutSchema)
