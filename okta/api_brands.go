...
func (a *BrandsAPIService) CreateBrandExecute(r ApiCreateBrandRequest) (*Brand, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BrandsAPIService.CreateBrand")
	if err != nil {
...
// Execute executes the request
func (a *BrandsAPIService) DeleteBrandExecute(r ApiDeleteBrandRequest) (*APIResponse, error) {
	var (
...
func (a *BrandsAPIService) ListBrandDomainsExecute(r ApiListBrandDomainsRequest) ([]DomainResponse, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BrandsAPIService.ListBrandDomains")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *BrandsAPIService) ListBrandsExecute(r ApiListBrandsRequest) ([]BrandWithEmbedded, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BrandsAPIService.ListBrands")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *BrandsAPIService) ReplaceBrandExecute(r ApiReplaceBrandRequest) (*Brand, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BrandsAPIService.ReplaceBrand")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
