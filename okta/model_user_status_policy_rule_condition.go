...
// checks if the UserStatusPolicyRuleCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserStatusPolicyRuleCondition{}
...
func (o UserStatusPolicyRuleCondition) ToMap() (map[string]interface{}, error) {
...
func (o *UserStatusPolicyRuleCondition) UnmarshalJSON(data []byte) (err error) {
	varUserStatusPolicyRuleCondition := _UserStatusPolicyRuleCondition{}

	err = json.Unmarshal(data, &varUserStatusPolicyRuleCondition)
