...
// checks if the SamlRelayState type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SamlRelayState{}
...
func (o SamlRelayState) ToMap() (map[string]interface{}, error) {
...
func (o *SamlRelayState) UnmarshalJSON(data []byte) (err error) {
	varSamlRelayState := _SamlRelayState{}

	err = json.Unmarshal(data, &varSamlRelayState)
