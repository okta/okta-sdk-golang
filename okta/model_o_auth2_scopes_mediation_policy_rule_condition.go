...
// checks if the OAuth2ScopesMediationPolicyRuleCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OAuth2ScopesMediationPolicyRuleCondition{}
...
func (o OAuth2ScopesMediationPolicyRuleCondition) ToMap() (map[string]interface{}, error) {
...
func (o *OAuth2ScopesMediationPolicyRuleCondition) UnmarshalJSON(data []byte) (err error) {
	varOAuth2ScopesMediationPolicyRuleCondition := _OAuth2ScopesMediationPolicyRuleCondition{}

	err = json.Unmarshal(data, &varOAuth2ScopesMediationPolicyRuleCondition)
