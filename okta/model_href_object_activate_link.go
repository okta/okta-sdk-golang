...
// checks if the HrefObjectActivateLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HrefObjectActivateLink{}

// HrefObjectActivateLink Link to activate the resource
type HrefObjectActivateLink struct {
...
type _HrefObjectActivateLink HrefObjectActivateLink
...
func (o HrefObjectActivateLink) MarshalJSON() ([]byte, error) {
...
func (o HrefObjectActivateLink) ToMap() (map[string]interface{}, error) {
...
func (o *HrefObjectActivateLink) UnmarshalJSON(data []byte) (err error) {
	...
	varHrefObjectActivateLink := _HrefObjectActivateLink{}

	err = json.Unmarshal(data, &varHrefObjectActivateLink)

	if err != nil {
		return err
	}

	*o = HrefObjectActivateLink(varHrefObjectActivateLink)
...
type NullableHrefObjectActivateLink struct {
	value *HrefObjectActivateLink
	isSet bool
}

func (v NullableHrefObjectActivateLink) Get() *HrefObjectActivateLink {
	return v.value
}

func (v *NullableHrefObjectActivateLink) Set(val *HrefObjectActivateLink) {
	v.value = val
	v.isSet = true
}

func (v NullableHrefObjectActivateLink) IsSet() bool {
	return v.isSet
}

func (v *NullableHrefObjectActivateLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHrefObjectActivateLink(val *HrefObjectActivateLink) *NullableHrefObjectActivateLink {
	return &NullableHrefObjectActivateLink{value: val, isSet: true}
}

func (v NullableHrefObjectActivateLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHrefObjectActivateLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
