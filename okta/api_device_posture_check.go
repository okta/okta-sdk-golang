...
type DevicePostureCheckAPI interface {
	...
	*/
	...
	// CreateDevicePostureCheckExecute executes the request
	...
	*/
	...
	// DeleteDevicePostureCheckExecute executes the request
	...
	*/
	...
	// GetDevicePostureCheckExecute executes the request
	//  @return DevicePostureCheck
	...
	*/
	...
	// ListDefaultDevicePostureChecksExecute executes the request
	//  @return []DevicePostureCheck
	...
	*/
	...
	// ListDevicePostureChecksExecute executes the request
	//  @return []DevicePostureCheck
	...
	*/
	...
	// ReplaceDevicePostureCheckExecute executes the request
	//  @return DevicePostureCheck
	ReplaceDevicePostureCheckExecute(r ApiReplaceDevicePostureCheckRequest) (*DevicePostureCheck, *APIResponse, error)
}

// DevicePostureCheckAPIService DevicePostureCheckAPI service
...
func (r ApiCreateDevicePostureCheckRequest) DevicePostureCheck(devicePostureCheck DevicePostureCheck) ApiCreateDevicePostureCheckRequest {
	r.devicePostureCheck = &devicePostureCheck
	return r
}

func (r ApiCreateDevicePostureCheckRequest) Execute() (*DevicePostureCheck, *APIResponse, error) {
	return r.ApiService.CreateDevicePostureCheckExecute(r)
}
...
func (a *DevicePostureCheckAPIService) CreateDevicePostureCheckExecute(r ApiCreateDevicePostureCheckRequest) (*DevicePostureCheck, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DevicePostureCheckAPIService.CreateDevicePostureCheck")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/device-posture-checks"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.devicePostureCheck == nil {
		return localVarReturnValue, nil, reportError("devicePostureCheck is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.devicePostureCheck
	if r.ctx != nil {
...
func (r ApiDeleteDevicePostureCheckRequest) Execute() (*APIResponse, error) {
	return r.ApiService.DeleteDevicePostureCheckExecute(r)
}
...
// Execute executes the request
func (a *DevicePostureCheckAPIService) DeleteDevicePostureCheckExecute(r ApiDeleteDevicePostureCheckRequest) (*APIResponse, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DevicePostureCheckAPIService.DeleteDevicePostureCheck")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/device-posture-checks/{postureCheckId}"
	localVarPath = strings.Replace(localVarPath, "{"+"postureCheckId"+"}", url.PathEscape(parameterToString(r.postureCheckId, "")), -1)
...
func (r ApiGetDevicePostureCheckRequest) Execute() (*DevicePostureCheck, *APIResponse, error) {
	return r.ApiService.GetDevicePostureCheckExecute(r)
}
...
func (a *DevicePostureCheckAPIService) GetDevicePostureCheckExecute(r ApiGetDevicePostureCheckRequest) (*DevicePostureCheck, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DevicePostureCheckAPIService.GetDevicePostureCheck")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiListDefaultDevicePostureChecksRequest) Execute() ([]DevicePostureCheck, *APIResponse, error) {
	return r.ApiService.ListDefaultDevicePostureChecksExecute(r)
}
...
func (a *DevicePostureCheckAPIService) ListDefaultDevicePostureChecksExecute(r ApiListDefaultDevicePostureChecksRequest) ([]DevicePostureCheck, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DevicePostureCheckAPIService.ListDefaultDevicePostureChecks")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/device-posture-checks/default"
...
func (r ApiListDevicePostureChecksRequest) Execute() ([]DevicePostureCheck, *APIResponse, error) {
	return r.ApiService.ListDevicePostureChecksExecute(r)
}
...
func (a *DevicePostureCheckAPIService) ListDevicePostureChecksExecute(r ApiListDevicePostureChecksRequest) ([]DevicePostureCheck, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DevicePostureCheckAPIService.ListDevicePostureChecks")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiReplaceDevicePostureCheckRequest) Execute() (*DevicePostureCheck, *APIResponse, error) {
	return r.ApiService.ReplaceDevicePostureCheckExecute(r)
}
...
func (a *DevicePostureCheckAPIService) ReplaceDevicePostureCheckExecute(r ApiReplaceDevicePostureCheckRequest) (*DevicePostureCheck, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DevicePostureCheckAPIService.ReplaceDevicePostureCheck")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
