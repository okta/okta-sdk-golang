...
type UISchemaAPI interface {
	...
	*/
	...
	//  @return UISchemasResponseObject
	ReplaceUISchemasExecute(r ApiReplaceUISchemasRequest) (*UISchemasResponseObject, *APIResponse, error)
}
...
func (r ApiCreateUISchemaRequest) Execute() (*UISchemasResponseObject, *APIResponse, error) {
...
func (a *UISchemaAPIService) CreateUISchemaExecute(r ApiCreateUISchemaRequest) (*UISchemasResponseObject, *APIResponse, error) {
	...
	if r.uischemabody == nil {
		return localVarReturnValue, nil, reportError("uischemabody is required and must be specified")
	}
...
func (r ApiGetUISchemaRequest) Execute() (*UISchemasResponseObject, *APIResponse, error) {
...
func (r ApiListUISchemasRequest) Execute() ([]UISchemasResponseObject, *APIResponse, error) {
...
func (r ApiReplaceUISchemasRequest) Execute() (*UISchemasResponseObject, *APIResponse, error) {
...
func (a *UISchemaAPIService) ReplaceUISchemasExecute(r ApiReplaceUISchemasRequest) (*UISchemasResponseObject, *APIResponse, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.updateUISchemaBody == nil {
		return localVarReturnValue, nil, reportError("updateUISchemaBody is required and must be specified")
	}
