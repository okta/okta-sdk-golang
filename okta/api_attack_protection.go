...
func (r ApiReplaceAuthenticatorSettingsRequest) Execute() (*AttackProtectionAuthenticatorSettings, *APIResponse, error) {
...
func (a *AttackProtectionAPIService) ReplaceAuthenticatorSettingsExecute(r ApiReplaceAuthenticatorSettingsRequest) (*AttackProtectionAuthenticatorSettings, *APIResponse, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.authenticatorSettings == nil {
		return localVarReturnValue, nil, reportError("authenticatorSettings is required and must be specified")
	}
