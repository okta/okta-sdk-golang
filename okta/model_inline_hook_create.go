...
// checks if the InlineHookCreate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineHookCreate{}
...
func (o InlineHookCreate) ToMap() (map[string]interface{}, error) {
...
func (o *InlineHookCreate) UnmarshalJSON(data []byte) (err error) {
	varInlineHookCreate := _InlineHookCreate{}

	err = json.Unmarshal(data, &varInlineHookCreate)
