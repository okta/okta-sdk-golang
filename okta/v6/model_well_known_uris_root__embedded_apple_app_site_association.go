...
func (o *WellKnownURIsRootEmbeddedAppleAppSiteAssociation) UnmarshalJSON(bytes []byte) (err error) {
	varWellKnownURIsRootEmbeddedAppleAppSiteAssociation := _WellKnownURIsRootEmbeddedAppleAppSiteAssociation{}

	err = json.Unmarshal(bytes, &varWellKnownURIsRootEmbeddedAppleAppSiteAssociation)
	if err == nil {
