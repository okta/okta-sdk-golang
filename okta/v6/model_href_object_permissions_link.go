...
// checks if the HrefObjectPermissionsLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HrefObjectPermissionsLink{}

// HrefObjectPermissionsLink Link to the permissions resource
type HrefObjectPermissionsLink struct {
...
type _HrefObjectPermissionsLink HrefObjectPermissionsLink
...
func NewHrefObjectPermissionsLink(href string) *HrefObjectPermissionsLink {
	this := HrefObjectPermissionsLink{}
	this.Href = href
	return &this
}
...
func (o HrefObjectPermissionsLink) MarshalJSON() ([]byte, error) {
...
func (o HrefObjectPermissionsLink) ToMap() (map[string]interface{}, error) {
...
func (o *HrefObjectPermissionsLink) UnmarshalJSON(data []byte) (err error) {
	...
	varHrefObjectPermissionsLink := _HrefObjectPermissionsLink{}

	err = json.Unmarshal(data, &varHrefObjectPermissionsLink)

	if err != nil {
		return err
	}

	*o = HrefObjectPermissionsLink(varHrefObjectPermissionsLink)
...
type NullableHrefObjectPermissionsLink struct {
	value *HrefObjectPermissionsLink
	isSet bool
}

func (v NullableHrefObjectPermissionsLink) Get() *HrefObjectPermissionsLink {
	return v.value
}

func (v *NullableHrefObjectPermissionsLink) Set(val *HrefObjectPermissionsLink) {
	v.value = val
	v.isSet = true
}

func (v NullableHrefObjectPermissionsLink) IsSet() bool {
	return v.isSet
}

func (v *NullableHrefObjectPermissionsLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHrefObjectPermissionsLink(val *HrefObjectPermissionsLink) *NullableHrefObjectPermissionsLink {
	return &NullableHrefObjectPermissionsLink{value: val, isSet: true}
}

func (v NullableHrefObjectPermissionsLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHrefObjectPermissionsLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
