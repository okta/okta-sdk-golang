...
type _OrgCreationAdminCredentialsPassword OrgCreationAdminCredentialsPassword
...
func NewOrgCreationAdminCredentialsPassword() *OrgCreationAdminCredentialsPassword {
	this := OrgCreationAdminCredentialsPassword{}
	return &this
}
...
type NullableOrgCreationAdminCredentialsPassword struct {
	value *OrgCreationAdminCredentialsPassword
	isSet bool
}

func (v NullableOrgCreationAdminCredentialsPassword) Get() *OrgCreationAdminCredentialsPassword {
	return v.value
}

func (v *NullableOrgCreationAdminCredentialsPassword) Set(val *OrgCreationAdminCredentialsPassword) {
	v.value = val
	v.isSet = true
}

func (v NullableOrgCreationAdminCredentialsPassword) IsSet() bool {
	return v.isSet
}

func (v *NullableOrgCreationAdminCredentialsPassword) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrgCreationAdminCredentialsPassword(val *OrgCreationAdminCredentialsPassword) *NullableOrgCreationAdminCredentialsPassword {
	return &NullableOrgCreationAdminCredentialsPassword{value: val, isSet: true}
}

func (v NullableOrgCreationAdminCredentialsPassword) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrgCreationAdminCredentialsPassword) UnmarshalJSON(src []byte) error {
	v.isSet = true
