...
// checks if the InactivityPolicyRuleCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InactivityPolicyRuleCondition{}
...
func (o InactivityPolicyRuleCondition) ToMap() (map[string]interface{}, error) {
...
func (o *InactivityPolicyRuleCondition) UnmarshalJSON(data []byte) (err error) {
	varInactivityPolicyRuleCondition := _InactivityPolicyRuleCondition{}

	err = json.Unmarshal(data, &varInactivityPolicyRuleCondition)
