...
// SetPrimaryFactor gets a reference to the given string and assigns it to the PrimaryFactor field.
...
func (o *OktaSignOnPolicyRuleSignonActions) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		delete(additionalProperties, "primaryFactor")
