...
// checks if the LogStreamSettingsAws type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LogStreamSettingsAws{}
...
func (o LogStreamSettingsAws) ToMap() (map[string]interface{}, error) {
...
func (o *LogStreamSettingsAws) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varLogStreamSettingsAws)
