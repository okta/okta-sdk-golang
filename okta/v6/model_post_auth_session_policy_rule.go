...
func (o *PostAuthSessionPolicyRule) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varPostAuthSessionPolicyRuleWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varPostAuthSessionPolicyRule)
	if err == nil {
