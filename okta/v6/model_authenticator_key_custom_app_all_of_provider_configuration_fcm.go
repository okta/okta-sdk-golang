...
// checks if the AuthenticatorKeyCustomAppAllOfProviderConfigurationFcm type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthenticatorKeyCustomAppAllOfProviderConfigurationFcm{}
...
func (o AuthenticatorKeyCustomAppAllOfProviderConfigurationFcm) ToMap() (map[string]interface{}, error) {
...
func (o *AuthenticatorKeyCustomAppAllOfProviderConfigurationFcm) UnmarshalJSON(data []byte) (err error) {
	varAuthenticatorKeyCustomAppAllOfProviderConfigurationFcm := _AuthenticatorKeyCustomAppAllOfProviderConfigurationFcm{}

	err = json.Unmarshal(data, &varAuthenticatorKeyCustomAppAllOfProviderConfigurationFcm)
