...
// checks if the ResendUserFactor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResendUserFactor{}
...
func (o ResendUserFactor) ToMap() (map[string]interface{}, error) {
...
func (o *ResendUserFactor) UnmarshalJSON(data []byte) (err error) {
	varResendUserFactor := _ResendUserFactor{}

	err = json.Unmarshal(data, &varResendUserFactor)
