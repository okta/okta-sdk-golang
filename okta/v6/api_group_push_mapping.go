...
type GroupPushMappingAPI interface {
	...
	*/
	...
	// CreateGroupPushMappingExecute executes the request
	...
	*/
	...
	// DeleteGroupPushMappingExecute executes the request
	...
	*/
	...
	// GetGroupPushMappingExecute executes the request
	//  @return GroupPushMapping
	...
	*/
	...
	// ListGroupPushMappingsExecute executes the request
	//  @return []GroupPushMapping
	...
	*/
	...
	// UpdateGroupPushMappingExecute executes the request
	//  @return GroupPushMapping
	UpdateGroupPushMappingExecute(r ApiUpdateGroupPushMappingRequest) (*GroupPushMapping, *APIResponse, error)
}

// GroupPushMappingAPIService GroupPushMappingAPI service
...
func (r ApiCreateGroupPushMappingRequest) Body(body CreateGroupPushMappingRequest) ApiCreateGroupPushMappingRequest {
	r.body = &body
	return r
}

func (r ApiCreateGroupPushMappingRequest) Execute() (*GroupPushMapping, *APIResponse, error) {
	return r.ApiService.CreateGroupPushMappingExecute(r)
}
...
func (a *GroupPushMappingAPIService) CreateGroupPushMappingExecute(r ApiCreateGroupPushMappingRequest) (*GroupPushMapping, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GroupPushMappingAPIService.CreateGroupPushMapping")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/apps/{appId}/group-push/mappings"
...
func (r ApiDeleteGroupPushMappingRequest) DeleteTargetGroup(deleteTargetGroup bool) ApiDeleteGroupPushMappingRequest {
	r.deleteTargetGroup = &deleteTargetGroup
	return r
}

func (r ApiDeleteGroupPushMappingRequest) Execute() (*APIResponse, error) {
	return r.ApiService.DeleteGroupPushMappingExecute(r)
}
...
// Execute executes the request
func (a *GroupPushMappingAPIService) DeleteGroupPushMappingExecute(r ApiDeleteGroupPushMappingRequest) (*APIResponse, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GroupPushMappingAPIService.DeleteGroupPushMapping")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/apps/{appId}/group-push/mappings/{mappingId}"
	localVarPath = strings.Replace(localVarPath, "{"+"appId"+"}", url.PathEscape(parameterToString(r.appId, "")), -1)
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.deleteTargetGroup == nil {
		return nil, reportError("deleteTargetGroup is required and must be specified")
	}

	localVarQueryParams.Add("deleteTargetGroup", parameterToString(*r.deleteTargetGroup, ""))
	// to determine the Content-Type header
...
func (r ApiGetGroupPushMappingRequest) Execute() (*GroupPushMapping, *APIResponse, error) {
	return r.ApiService.GetGroupPushMappingExecute(r)
}
...
func (a *GroupPushMappingAPIService) GetGroupPushMappingExecute(r ApiGetGroupPushMappingRequest) (*GroupPushMapping, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GroupPushMappingAPIService.GetGroupPushMapping")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiListGroupPushMappingsRequest) After(after string) ApiListGroupPushMappingsRequest {
	r.after = &after
	return r
}

// Specifies the number of results returned
func (r ApiListGroupPushMappingsRequest) Limit(limit int32) ApiListGroupPushMappingsRequest {
	r.limit = &limit
	return r
}
...
func (r ApiListGroupPushMappingsRequest) LastUpdated(lastUpdated string) ApiListGroupPushMappingsRequest {
...
func (r ApiListGroupPushMappingsRequest) Status(status string) ApiListGroupPushMappingsRequest {
	r.status = &status
	return r
}

func (r ApiListGroupPushMappingsRequest) Execute() ([]GroupPushMapping, *APIResponse, error) {
	return r.ApiService.ListGroupPushMappingsExecute(r)
}
...
func (a *GroupPushMappingAPIService) ListGroupPushMappingsExecute(r ApiListGroupPushMappingsRequest) ([]GroupPushMapping, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GroupPushMappingAPIService.ListGroupPushMappings")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	if r.sourceGroupId != nil {
		localVarQueryParams.Add("sourceGroupId", parameterToString(*r.sourceGroupId, ""))
	}
	if r.status != nil {
...
func (r ApiUpdateGroupPushMappingRequest) Body(body UpdateGroupPushMappingRequest) ApiUpdateGroupPushMappingRequest {
	r.body = &body
	return r
}

func (r ApiUpdateGroupPushMappingRequest) Execute() (*GroupPushMapping, *APIResponse, error) {
	return r.ApiService.UpdateGroupPushMappingExecute(r)
}
...
func (a *GroupPushMappingAPIService) UpdateGroupPushMappingExecute(r ApiUpdateGroupPushMappingRequest) (*GroupPushMapping, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GroupPushMappingAPIService.UpdateGroupPushMapping")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
