...
// checks if the AuthenticatorKeySymantecVip type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthenticatorKeySymantecVip{}
...
func (o AuthenticatorKeySymantecVip) ToMap() (map[string]interface{}, error) {
...
func (o *AuthenticatorKeySymantecVip) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAuthenticatorKeySymantecVipWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varAuthenticatorKeySymantecVip)
	if err == nil {
