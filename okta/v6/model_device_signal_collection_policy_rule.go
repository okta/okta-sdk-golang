...
func (o *DeviceSignalCollectionPolicyRule) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varDeviceSignalCollectionPolicyRuleWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varDeviceSignalCollectionPolicyRule)
	if err == nil {
