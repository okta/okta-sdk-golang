...
// checks if the UserFactorWeb type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserFactorWeb{}
...
func (o UserFactorWeb) ToMap() (map[string]interface{}, error) {
...
func (o *UserFactorWeb) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varUserFactorWebWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varUserFactorWeb)
	if err == nil {
