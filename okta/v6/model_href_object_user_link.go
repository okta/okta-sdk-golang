...
// checks if the HrefObjectUserLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HrefObjectUserLink{}

// HrefObjectUserLink Link to the user resource
type HrefObjectUserLink struct {
...
type _HrefObjectUserLink HrefObjectUserLink
...
func (o HrefObjectUserLink) MarshalJSON() ([]byte, error) {
...
func (o HrefObjectUserLink) ToMap() (map[string]interface{}, error) {
...
func (o *HrefObjectUserLink) UnmarshalJSON(data []byte) (err error) {
	...
	varHrefObjectUserLink := _HrefObjectUserLink{}

	err = json.Unmarshal(data, &varHrefObjectUserLink)

	if err != nil {
		return err
	}

	*o = HrefObjectUserLink(varHrefObjectUserLink)
...
type NullableHrefObjectUserLink struct {
	value *HrefObjectUserLink
	isSet bool
}

func (v NullableHrefObjectUserLink) Get() *HrefObjectUserLink {
	return v.value
}

func (v *NullableHrefObjectUserLink) Set(val *HrefObjectUserLink) {
	v.value = val
	v.isSet = true
}

func (v NullableHrefObjectUserLink) IsSet() bool {
	return v.isSet
}

func (v *NullableHrefObjectUserLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHrefObjectUserLink(val *HrefObjectUserLink) *NullableHrefObjectUserLink {
	return &NullableHrefObjectUserLink{value: val, isSet: true}
}

func (v NullableHrefObjectUserLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHrefObjectUserLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
