...
func (o *PostAuthSessionPolicyRuleTerminateSession) UnmarshalJSON(bytes []byte) (err error) {
	varPostAuthSessionPolicyRuleTerminateSession := _PostAuthSessionPolicyRuleTerminateSession{}

	err = json.Unmarshal(bytes, &varPostAuthSessionPolicyRuleTerminateSession)
	if err == nil {
