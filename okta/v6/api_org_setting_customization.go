...
type OrgSettingCustomizationAPI interface {
	...
	*/
	...
	// SetOrgHideOktaUIFooterExecute executes the request
	//  @return OrgPreferences
...
func (a *OrgSettingCustomizationAPIService) GetOrgPreferencesExecute(r ApiGetOrgPreferencesRequest) (*OrgPreferences, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrgSettingCustomizationAPIService.GetOrgPreferences")
	if err != nil {
...
func (r ApiSetOrgHideOktaUIFooterRequest) Execute() (*OrgPreferences, *APIResponse, error) {
	return r.ApiService.SetOrgHideOktaUIFooterExecute(r)
}
...
func (a *OrgSettingCustomizationAPIService) SetOrgHideOktaUIFooterExecute(r ApiSetOrgHideOktaUIFooterRequest) (*OrgPreferences, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrgSettingCustomizationAPIService.SetOrgHideOktaUIFooter")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiSetOrgShowOktaUIFooterRequest) Execute() (*OrgPreferences, *APIResponse, error) {
	return r.ApiService.SetOrgShowOktaUIFooterExecute(r)
}
...
func (a *OrgSettingCustomizationAPIService) SetOrgShowOktaUIFooterExecute(r ApiSetOrgShowOktaUIFooterRequest) (*OrgPreferences, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrgSettingCustomizationAPIService.SetOrgShowOktaUIFooter")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
