...
// SetEnroll gets a reference to the given HrefObject and assigns it to the Enroll field.
...
// SetQuestion gets a reference to the given HrefObject and assigns it to the Question field.
