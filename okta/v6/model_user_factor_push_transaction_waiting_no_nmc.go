...
type _UserFactorPushTransactionWaitingNoNMC UserFactorPushTransactionWaitingNoNMC
...
func NewUserFactorPushTransactionWaitingNoNMC() *UserFactorPushTransactionWaitingNoNMC {
	this := UserFactorPushTransactionWaitingNoNMC{}
	return &this
}
...
// SetLinks gets a reference to the given UserFactorPushTransactionWaitingNoNMCAllOfLinks and assigns it to the Links field.
...
func (o *UserFactorPushTransactionWaitingNoNMC) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		varUserFactorPushTransactionWaitingNoNMC.Links = varUserFactorPushTransactionWaitingNoNMCWithoutEmbeddedStruct.Links
		*o = UserFactorPushTransactionWaitingNoNMC(varUserFactorPushTransactionWaitingNoNMC)
	} else {
		return err
	}
...
type NullableUserFactorPushTransactionWaitingNoNMC struct {
	value *UserFactorPushTransactionWaitingNoNMC
	isSet bool
}

func (v NullableUserFactorPushTransactionWaitingNoNMC) Get() *UserFactorPushTransactionWaitingNoNMC {
	return v.value
}

func (v *NullableUserFactorPushTransactionWaitingNoNMC) Set(val *UserFactorPushTransactionWaitingNoNMC) {
	v.value = val
	v.isSet = true
}

func (v NullableUserFactorPushTransactionWaitingNoNMC) IsSet() bool {
	return v.isSet
}

func (v *NullableUserFactorPushTransactionWaitingNoNMC) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserFactorPushTransactionWaitingNoNMC(val *UserFactorPushTransactionWaitingNoNMC) *NullableUserFactorPushTransactionWaitingNoNMC {
	return &NullableUserFactorPushTransactionWaitingNoNMC{value: val, isSet: true}
}

func (v NullableUserFactorPushTransactionWaitingNoNMC) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserFactorPushTransactionWaitingNoNMC) UnmarshalJSON(src []byte) error {
	v.isSet = true
