...
// checks if the TrendMicroApexOneServiceApplication type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrendMicroApexOneServiceApplication{}
...
type _TrendMicroApexOneServiceApplication TrendMicroApexOneServiceApplication
...
func NewTrendMicroApexOneServiceApplication(label string, name string, settings TrendMicroApexOneServiceApplicationSettings) *TrendMicroApexOneServiceApplication {
	this := TrendMicroApexOneServiceApplication{}
	this.Label = label
	this.Name = name
...
func (o TrendMicroApexOneServiceApplication) MarshalJSON() ([]byte, error) {
...
func (o TrendMicroApexOneServiceApplication) ToMap() (map[string]interface{}, error) {
...
func (o *TrendMicroApexOneServiceApplication) UnmarshalJSON(data []byte) (err error) {
	...
	varTrendMicroApexOneServiceApplication := _TrendMicroApexOneServiceApplication{}

	err = json.Unmarshal(data, &varTrendMicroApexOneServiceApplication)

	if err != nil {
		return err
	}

	*o = TrendMicroApexOneServiceApplication(varTrendMicroApexOneServiceApplication)
...
type NullableTrendMicroApexOneServiceApplication struct {
	value *TrendMicroApexOneServiceApplication
	isSet bool
}

func (v NullableTrendMicroApexOneServiceApplication) Get() *TrendMicroApexOneServiceApplication {
	return v.value
}

func (v *NullableTrendMicroApexOneServiceApplication) Set(val *TrendMicroApexOneServiceApplication) {
	v.value = val
	v.isSet = true
}

func (v NullableTrendMicroApexOneServiceApplication) IsSet() bool {
	return v.isSet
}

func (v *NullableTrendMicroApexOneServiceApplication) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrendMicroApexOneServiceApplication(val *TrendMicroApexOneServiceApplication) *NullableTrendMicroApexOneServiceApplication {
	return &NullableTrendMicroApexOneServiceApplication{value: val, isSet: true}
}

func (v NullableTrendMicroApexOneServiceApplication) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrendMicroApexOneServiceApplication) UnmarshalJSON(src []byte) error {
	v.isSet = true
