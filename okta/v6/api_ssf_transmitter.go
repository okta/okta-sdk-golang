...
A maximum of 10 SSF Stream configurations can be created for one org.
	...
	*/
	...
	// CreateSsfStreamExecute executes the request
...
If the `stream_id` is not provided in the query string, the associated stream with the Client ID (through the request OAuth 2.0 access token) is deleted. Otherwise, the SSF Stream with the `stream_id` is deleted, if found.
	...
	*/
	...
	// DeleteSsfStreamExecute executes the request
	...
	*/
	...
	// GetSsfStreamStatusExecute executes the request
	//  @return StreamStatus
...
As Stream configurations are tied to a Client ID, only the Stream associated with the Client ID of the request OAuth 2.0 access token can be viewed.
	...
	*/
	...
	// GetSsfStreamsExecute executes the request
	...
	*/
	...
	// GetWellknownSsfMetadataExecute executes the request
...
If the `stream_id` isn't provided in the request body, the associated stream with the Client ID (through the request OAuth 2.0 access token) is replaced.
	...
	*/
	...
	// ReplaceSsfStreamExecute executes the request
	//  @return StreamConfiguration
...
If the `stream_id` isn't provided in the request body, the associated stream with the Client ID (through the request OAuth 2.0 access token) is updated.
	...
	*/
	...
	// UpdateSsfStreamExecute executes the request
	//  @return StreamConfiguration
...
> **Note:** A successful response doesn't indicate that the Verification Event
	...
	*/
	...
	// VerifySsfStreamExecute executes the request
	VerifySsfStreamExecute(r ApiVerifySsfStreamRequest) (*APIResponse, error)
}
...
func (r ApiCreateSsfStreamRequest) Instance(instance StreamConfigurationCreateRequest) ApiCreateSsfStreamRequest {
	r.instance = &instance
	return r
}

func (r ApiCreateSsfStreamRequest) Execute() (*StreamConfiguration, *APIResponse, error) {
	return r.ApiService.CreateSsfStreamExecute(r)
}
...
func (a *SSFTransmitterAPIService) CreateSsfStreamExecute(r ApiCreateSsfStreamRequest) (*StreamConfiguration, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SSFTransmitterAPIService.CreateSsfStream")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/ssf/stream"
...
func (r ApiDeleteSsfStreamRequest) StreamId(streamId string) ApiDeleteSsfStreamRequest {
	r.streamId = &streamId
	return r
}

func (r ApiDeleteSsfStreamRequest) Execute() (*APIResponse, error) {
	return r.ApiService.DeleteSsfStreamExecute(r)
}
...
// Execute executes the request
func (a *SSFTransmitterAPIService) DeleteSsfStreamExecute(r ApiDeleteSsfStreamRequest) (*APIResponse, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SSFTransmitterAPIService.DeleteSsfStream")
	if err != nil {
...
func (r ApiGetSsfStreamStatusRequest) Execute() (*StreamStatus, *APIResponse, error) {
	return r.ApiService.GetSsfStreamStatusExecute(r)
}
...
func (a *SSFTransmitterAPIService) GetSsfStreamStatusExecute(r ApiGetSsfStreamStatusRequest) (*StreamStatus, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SSFTransmitterAPIService.GetSsfStreamStatus")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/ssf/stream/status"
...
func (r ApiGetSsfStreamsRequest) Execute() (*GetSsfStreams200Response, *APIResponse, error) {
	return r.ApiService.GetSsfStreamsExecute(r)
}
...
func (a *SSFTransmitterAPIService) GetSsfStreamsExecute(r ApiGetSsfStreamsRequest) (*GetSsfStreams200Response, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SSFTransmitterAPIService.GetSsfStreams")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetWellknownSsfMetadataRequest) Execute() (*WellKnownSSFMetadata, *APIResponse, error) {
	return r.ApiService.GetWellknownSsfMetadataExecute(r)
}
...
func (a *SSFTransmitterAPIService) GetWellknownSsfMetadataExecute(r ApiGetWellknownSsfMetadataRequest) (*WellKnownSSFMetadata, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SSFTransmitterAPIService.GetWellknownSsfMetadata")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiReplaceSsfStreamRequest) Instance(instance StreamConfiguration) ApiReplaceSsfStreamRequest {
	r.instance = &instance
	return r
}

func (r ApiReplaceSsfStreamRequest) Execute() (*StreamConfiguration, *APIResponse, error) {
	return r.ApiService.ReplaceSsfStreamExecute(r)
}
...
func (a *SSFTransmitterAPIService) ReplaceSsfStreamExecute(r ApiReplaceSsfStreamRequest) (*StreamConfiguration, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SSFTransmitterAPIService.ReplaceSsfStream")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdateSsfStreamRequest) Instance(instance StreamConfiguration) ApiUpdateSsfStreamRequest {
	r.instance = &instance
	return r
}

func (r ApiUpdateSsfStreamRequest) Execute() (*StreamConfiguration, *APIResponse, error) {
	return r.ApiService.UpdateSsfStreamExecute(r)
}
...
func (a *SSFTransmitterAPIService) UpdateSsfStreamExecute(r ApiUpdateSsfStreamRequest) (*StreamConfiguration, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SSFTransmitterAPIService.UpdateSsfStream")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiVerifySsfStreamRequest) Instance(instance StreamVerificationRequest) ApiVerifySsfStreamRequest {
	r.instance = &instance
	return r
}

func (r ApiVerifySsfStreamRequest) Execute() (*APIResponse, error) {
	return r.ApiService.VerifySsfStreamExecute(r)
}
...
// Execute executes the request
func (a *SSFTransmitterAPIService) VerifySsfStreamExecute(r ApiVerifySsfStreamRequest) (*APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SSFTransmitterAPIService.VerifySsfStream")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/ssf/stream/verification"
