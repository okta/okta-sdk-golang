...
// checks if the HrefObjectRetrieveAerialConsent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HrefObjectRetrieveAerialConsent{}

// HrefObjectRetrieveAerialConsent Link to retrieve Okta Aerial consent for your Org
type HrefObjectRetrieveAerialConsent struct {
...
type _HrefObjectRetrieveAerialConsent HrefObjectRetrieveAerialConsent
...
func NewHrefObjectRetrieveAerialConsent(href string) *HrefObjectRetrieveAerialConsent {
	this := HrefObjectRetrieveAerialConsent{}
	this.Href = href
	return &this
}
...
func (o HrefObjectRetrieveAerialConsent) MarshalJSON() ([]byte, error) {
...
func (o HrefObjectRetrieveAerialConsent) ToMap() (map[string]interface{}, error) {
...
func (o *HrefObjectRetrieveAerialConsent) UnmarshalJSON(data []byte) (err error) {
	...
	varHrefObjectRetrieveAerialConsent := _HrefObjectRetrieveAerialConsent{}

	err = json.Unmarshal(data, &varHrefObjectRetrieveAerialConsent)

	if err != nil {
		return err
	}

	*o = HrefObjectRetrieveAerialConsent(varHrefObjectRetrieveAerialConsent)
...
type NullableHrefObjectRetrieveAerialConsent struct {
	value *HrefObjectRetrieveAerialConsent
	isSet bool
}

func (v NullableHrefObjectRetrieveAerialConsent) Get() *HrefObjectRetrieveAerialConsent {
	return v.value
}

func (v *NullableHrefObjectRetrieveAerialConsent) Set(val *HrefObjectRetrieveAerialConsent) {
	v.value = val
	v.isSet = true
}

func (v NullableHrefObjectRetrieveAerialConsent) IsSet() bool {
	return v.isSet
}

func (v *NullableHrefObjectRetrieveAerialConsent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHrefObjectRetrieveAerialConsent(val *HrefObjectRetrieveAerialConsent) *NullableHrefObjectRetrieveAerialConsent {
	return &NullableHrefObjectRetrieveAerialConsent{value: val, isSet: true}
}

func (v NullableHrefObjectRetrieveAerialConsent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHrefObjectRetrieveAerialConsent) UnmarshalJSON(src []byte) error {
	v.isSet = true
