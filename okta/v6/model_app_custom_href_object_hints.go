...
// checks if the AppCustomHrefObjectHints type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppCustomHrefObjectHints{}
...
func (o AppCustomHrefObjectHints) ToMap() (map[string]interface{}, error) {
...
func (o *AppCustomHrefObjectHints) UnmarshalJSON(data []byte) (err error) {
	varAppCustomHrefObjectHints := _AppCustomHrefObjectHints{}

	err = json.Unmarshal(data, &varAppCustomHrefObjectHints)
