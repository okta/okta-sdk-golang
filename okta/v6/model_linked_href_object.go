...
// checks if the LinkedHrefObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LinkedHrefObject{}
...
func (o LinkedHrefObject) ToMap() (map[string]interface{}, error) {
...
func (o *LinkedHrefObject) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varLinkedHrefObject)
