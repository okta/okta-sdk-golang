...
> **Note:** To list all devices registered to an org, use the [List all devices endpoint in the Devices API](/openapi/okta-management/management/tag/Device/#tag/Device/operation/listDevices).
	...
	*/
	...
	// ListUserDevicesExecute executes the request
	//  @return []UserDevice
...
// UserResourcesAPIService UserResourcesAPI service
...
func (r ApiListAppLinksRequest) Execute() ([]AssignedAppLink, *APIResponse, error) {
...
func (a *UserResourcesAPIService) ListAppLinksExecute(r ApiListAppLinksRequest) ([]AssignedAppLink, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserResourcesAPIService.ListAppLinks")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/users/{id}/appLinks"
...
func (a *UserResourcesAPIService) ListUserClientsExecute(r ApiListUserClientsRequest) ([]OAuth2Client, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserResourcesAPIService.ListUserClients")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiListUserDevicesRequest) Execute() ([]UserDevice, *APIResponse, error) {
	return r.ApiService.ListUserDevicesExecute(r)
}
...
func (a *UserResourcesAPIService) ListUserDevicesExecute(r ApiListUserDevicesRequest) ([]UserDevice, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserResourcesAPIService.ListUserDevices")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/users/{userId}/devices"
	localVarPath = strings.Replace(localVarPath, "{"+"userId"+"}", url.PathEscape(parameterToString(r.userId, "")), -1)
...
func (a *UserResourcesAPIService) ListUserGroupsExecute(r ApiListUserGroupsRequest) ([]Group, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserResourcesAPIService.ListUserGroups")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/users/{id}/groups"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterToString(r.id, "")), -1)
