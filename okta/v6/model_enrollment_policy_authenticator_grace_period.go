...
func (o *EnrollmentPolicyAuthenticatorGracePeriod) UnmarshalJSON(bytes []byte) (err error) {
	varEnrollmentPolicyAuthenticatorGracePeriod := _EnrollmentPolicyAuthenticatorGracePeriod{}

	err = json.Unmarshal(bytes, &varEnrollmentPolicyAuthenticatorGracePeriod)
	if err == nil {
