...
type _OAuthAuthorizationEndpoint OAuthAuthorizationEndpoint
...
type NullableOAuthAuthorizationEndpoint struct {
	value *OAuthAuthorizationEndpoint
	isSet bool
}

func (v NullableOAuthAuthorizationEndpoint) Get() *OAuthAuthorizationEndpoint {
	return v.value
}

func (v *NullableOAuthAuthorizationEndpoint) Set(val *OAuthAuthorizationEndpoint) {
	v.value = val
	v.isSet = true
}

func (v NullableOAuthAuthorizationEndpoint) IsSet() bool {
	return v.isSet
}

func (v *NullableOAuthAuthorizationEndpoint) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOAuthAuthorizationEndpoint(val *OAuthAuthorizationEndpoint) *NullableOAuthAuthorizationEndpoint {
	return &NullableOAuthAuthorizationEndpoint{value: val, isSet: true}
}

func (v NullableOAuthAuthorizationEndpoint) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOAuthAuthorizationEndpoint) UnmarshalJSON(src []byte) error {
	v.isSet = true
