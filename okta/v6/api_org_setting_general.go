...
// OrgSettingGeneralAPIService OrgSettingGeneralAPI service
...
func (a *OrgSettingGeneralAPIService) GetOrgSettingsExecute(r ApiGetOrgSettingsRequest) (*OrgSetting, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrgSettingGeneralAPIService.GetOrgSettings")
	if err != nil {
...
func (a *OrgSettingGeneralAPIService) ReplaceOrgSettingsExecute(r ApiReplaceOrgSettingsRequest) (*OrgSetting, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrgSettingGeneralAPIService.ReplaceOrgSettings")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *OrgSettingGeneralAPIService) UpdateOrgSettingsExecute(r ApiUpdateOrgSettingsRequest) (*OrgSetting, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrgSettingGeneralAPIService.UpdateOrgSettings")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
