...
func (o *TokenHookResponseCommandsInnerValueInner) UnmarshalJSON(bytes []byte) (err error) {
	varTokenHookResponseCommandsInnerValueInner := _TokenHookResponseCommandsInnerValueInner{}

	err = json.Unmarshal(bytes, &varTokenHookResponseCommandsInnerValueInner)
	if err == nil {
