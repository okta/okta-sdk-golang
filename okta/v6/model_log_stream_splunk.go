...
// checks if the LogStreamSplunk type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LogStreamSplunk{}
...
func (o LogStreamSplunk) ToMap() (map[string]interface{}, error) {
...
func (o *LogStreamSplunk) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varLogStreamSplunkWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varLogStreamSplunk)
	if err == nil {
