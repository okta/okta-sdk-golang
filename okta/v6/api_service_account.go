...
type ServiceAccountAPI interface {
	...
	*/
	...
	//  @return AppServiceAccount
	UpdateAppServiceAccountExecute(r ApiUpdateAppServiceAccountRequest) (*AppServiceAccount, *APIResponse, error)
}
...
func (r ApiCreateAppServiceAccountRequest) Execute() (*AppServiceAccount, *APIResponse, error) {
...
func (a *ServiceAccountAPIService) CreateAppServiceAccountExecute(r ApiCreateAppServiceAccountRequest) (*AppServiceAccount, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServiceAccountAPIService.CreateAppServiceAccount")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/privileged-access/api/v1/service-accounts"
...
func (r ApiDeleteAppServiceAccountRequest) Execute() (*APIResponse, error) {
...
// Execute executes the request
func (a *ServiceAccountAPIService) DeleteAppServiceAccountExecute(r ApiDeleteAppServiceAccountRequest) (*APIResponse, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServiceAccountAPIService.DeleteAppServiceAccount")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/privileged-access/api/v1/service-accounts/{id}"
...
func (r ApiGetAppServiceAccountRequest) Execute() (*AppServiceAccount, *APIResponse, error) {
...
func (a *ServiceAccountAPIService) GetAppServiceAccountExecute(r ApiGetAppServiceAccountRequest) (*AppServiceAccount, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServiceAccountAPIService.GetAppServiceAccount")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiListAppServiceAccountsRequest) Execute() ([]AppServiceAccount, *APIResponse, error) {
...
func (a *ServiceAccountAPIService) ListAppServiceAccountsExecute(r ApiListAppServiceAccountsRequest) ([]AppServiceAccount, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServiceAccountAPIService.ListAppServiceAccounts")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdateAppServiceAccountRequest) Execute() (*AppServiceAccount, *APIResponse, error) {
...
func (a *ServiceAccountAPIService) UpdateAppServiceAccountExecute(r ApiUpdateAppServiceAccountRequest) (*AppServiceAccount, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServiceAccountAPIService.UpdateAppServiceAccount")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
