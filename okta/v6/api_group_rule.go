...
// GroupRuleAPIService GroupRuleAPI service
type GroupRuleAPIService service

type ApiActivateGroupRuleRequest struct {
	ctx context.Context
	ApiService GroupRuleAPI
	groupRuleId string
	retryCount int32
}
...
func (a *GroupRuleAPIService) ActivateGroupRuleExecute(r ApiActivateGroupRuleRequest) (*APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GroupRuleAPIService.ActivateGroupRule")
	if err != nil {
...
func (r ApiCreateGroupRuleRequest) GroupRule(groupRule CreateGroupRuleRequest) ApiCreateGroupRuleRequest {
...
func (a *GroupRuleAPIService) CreateGroupRuleExecute(r ApiCreateGroupRuleRequest) (*GroupRule, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GroupRuleAPIService.CreateGroupRule")
	if err != nil {
...
func (a *GroupRuleAPIService) DeactivateGroupRuleExecute(r ApiDeactivateGroupRuleRequest) (*APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GroupRuleAPIService.DeactivateGroupRule")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *GroupRuleAPIService) DeleteGroupRuleExecute(r ApiDeleteGroupRuleRequest) (*APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GroupRuleAPIService.DeleteGroupRule")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
Retrieves a specific group rule by ID from your org
 ...
 @return ApiGetGroupRuleRequest
*/
func (a *GroupRuleAPIService) GetGroupRule(ctx context.Context, groupRuleId string) ApiGetGroupRuleRequest {
	return ApiGetGroupRuleRequest{
		ApiService: a,
		ctx: ctx,
		groupRuleId: groupRuleId,
...
// Execute executes the request
//  @return GroupRule
func (a *GroupRuleAPIService) GetGroupRuleExecute(r ApiGetGroupRuleRequest) (*GroupRule, *APIResponse, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GroupRuleAPIService.GetGroupRule")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *GroupRuleAPIService) ListGroupRulesExecute(r ApiListGroupRulesRequest) ([]GroupRule, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GroupRuleAPIService.ListGroupRules")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *GroupRuleAPIService) ReplaceGroupRuleExecute(r ApiReplaceGroupRuleRequest) (*GroupRule, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GroupRuleAPIService.ReplaceGroupRule")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
