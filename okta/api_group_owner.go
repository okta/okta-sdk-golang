...
func (r ApiAssignGroupOwnerRequest) AssignGroupOwnerRequestBody(assignGroupOwnerRequestBody AssignGroupOwnerRequestBody) ApiAssignGroupOwnerRequest {
	r.assignGroupOwnerRequestBody = &assignGroupOwnerRequestBody
	return r
}
...
func (a *GroupOwnerAPIService) AssignGroupOwnerExecute(r ApiAssignGroupOwnerRequest) (*GroupOwner, *APIResponse, error) {
	...
	if r.assignGroupOwnerRequestBody == nil {
		return localVarReturnValue, nil, reportError("assignGroupOwnerRequestBody is required and must be specified")
	}
...
// Execute executes the request
func (a *GroupOwnerAPIService) DeleteGroupOwnerExecute(r ApiDeleteGroupOwnerRequest) (*APIResponse, error) {
	var (
