...
// OSVersion Specifies the OS version requirement.  There are two types of OS version requirements: * **Static**: It doesn't change until you update the policy. It is specified with the `osVersion.minimum` property. * **Dynamic**: It is relative to the latest major OS release and security patch. It is specified with the `osVersion.dynamicVersionRequirement` property.  > **Note:** You can't specify both `osVersion.minimum` and `osVersion.dynamicVersionRequirement` properties at the same time.
