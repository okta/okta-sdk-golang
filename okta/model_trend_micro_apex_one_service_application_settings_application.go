...
// checks if the TrendMicroApexOneServiceApplicationSettingsApplication type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrendMicroApexOneServiceApplicationSettingsApplication{}
...
func (o TrendMicroApexOneServiceApplicationSettingsApplication) ToMap() (map[string]interface{}, error) {
...
func (o *TrendMicroApexOneServiceApplicationSettingsApplication) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTrendMicroApexOneServiceApplicationSettingsApplication)
