...
// checks if the MtlsCredentials type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MtlsCredentials{}
...
func (o MtlsCredentials) ToMap() (map[string]interface{}, error) {
...
func (o *MtlsCredentials) UnmarshalJSON(data []byte) (err error) {
	varMtlsCredentials := _MtlsCredentials{}

	err = json.Unmarshal(data, &varMtlsCredentials)
