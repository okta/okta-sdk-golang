...
// checks if the AuthenticatorKeyWebauthn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthenticatorKeyWebauthn{}
...
func (o AuthenticatorKeyWebauthn) ToMap() (map[string]interface{}, error) {
...
func (o *AuthenticatorKeyWebauthn) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAuthenticatorKeyWebauthnWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varAuthenticatorKeyWebauthn)
	if err == nil {
