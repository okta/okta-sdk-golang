...
// PolicyMappingLinksAllOfAuthenticator struct for PolicyMappingLinksAllOfAuthenticator
type PolicyMappingLinksAllOfAuthenticator struct {
...
type _PolicyMappingLinksAllOfAuthenticator PolicyMappingLinksAllOfAuthenticator
...
func NewPolicyMappingLinksAllOfAuthenticator(href string) *PolicyMappingLinksAllOfAuthenticator {
	this := PolicyMappingLinksAllOfAuthenticator{}
	this.Href = href
	return &this
}
...
func (o PolicyMappingLinksAllOfAuthenticator) MarshalJSON() ([]byte, error) {
...
func (o *PolicyMappingLinksAllOfAuthenticator) UnmarshalJSON(bytes []byte) (err error) {
	varPolicyMappingLinksAllOfAuthenticator := _PolicyMappingLinksAllOfAuthenticator{}

	err = json.Unmarshal(bytes, &varPolicyMappingLinksAllOfAuthenticator)
	if err == nil {
		*o = PolicyMappingLinksAllOfAuthenticator(varPolicyMappingLinksAllOfAuthenticator)
	} else {
		return err
	}
...
type NullablePolicyMappingLinksAllOfAuthenticator struct {
	value *PolicyMappingLinksAllOfAuthenticator
	isSet bool
}

func (v NullablePolicyMappingLinksAllOfAuthenticator) Get() *PolicyMappingLinksAllOfAuthenticator {
	return v.value
}

func (v *NullablePolicyMappingLinksAllOfAuthenticator) Set(val *PolicyMappingLinksAllOfAuthenticator) {
	v.value = val
	v.isSet = true
}

func (v NullablePolicyMappingLinksAllOfAuthenticator) IsSet() bool {
	return v.isSet
}

func (v *NullablePolicyMappingLinksAllOfAuthenticator) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePolicyMappingLinksAllOfAuthenticator(val *PolicyMappingLinksAllOfAuthenticator) *NullablePolicyMappingLinksAllOfAuthenticator {
	return &NullablePolicyMappingLinksAllOfAuthenticator{value: val, isSet: true}
}

func (v NullablePolicyMappingLinksAllOfAuthenticator) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePolicyMappingLinksAllOfAuthenticator) UnmarshalJSON(src []byte) error {
	v.isSet = true
