...
type SubmissionRequest struct {
	// List of org-level properties used to set up the per-tenant configuration for your customers. For example the `subdomain` property can be used in the ACS URL: `https://${org.subdomain}.example.com/saml/login`.
	Config []SubmissionResponseConfigInner `json:"config,omitempty"`
	// A general description of your application and value of the Okta integration
	Description string `json:"description"`
	// ID of a Submission
	Id *string `json:"id,omitempty"`
	// Timestamp when the Submission was last published
	LastPublished *string `json:"lastPublished,omitempty"`
	// Timestamp when the Submission object was last updated
	LastUpdated *string `json:"lastUpdated,omitempty"`
	// ID of the user who made the last update
	LastUpdatedBy *string `json:"lastUpdatedBy,omitempty"`
	// URL to an uploaded application logo. This logo appears next to your app integration name in the OIN catalog.
