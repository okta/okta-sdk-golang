...
// checks if the UserSchemaAttributeMaster type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserSchemaAttributeMaster{}
...
func (o UserSchemaAttributeMaster) ToMap() (map[string]interface{}, error) {
...
func (o *UserSchemaAttributeMaster) UnmarshalJSON(data []byte) (err error) {
	varUserSchemaAttributeMaster := _UserSchemaAttributeMaster{}

	err = json.Unmarshal(data, &varUserSchemaAttributeMaster)
