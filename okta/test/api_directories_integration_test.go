...
func Test_okta_DirectoriesIntegrationAPIService(t *testing.T) {
	...
	t.Run("Test DirectoriesIntegrationAPIService InvokeRemoteScript", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var appInstanceId string

		resp, httpRes, err := apiClient.DirectoriesIntegrationAPI.InvokeRemoteScript(context.Background(), appInstanceId).Execute()
