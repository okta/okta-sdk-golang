...
// checks if the CsrPublishHrefHints type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CsrPublishHrefHints{}
...
func (o CsrPublishHrefHints) ToMap() (map[string]interface{}, error) {
...
func (o *CsrPublishHrefHints) UnmarshalJSON(data []byte) (err error) {
	varCsrPublishHrefHints := _CsrPublishHrefHints{}

	err = json.Unmarshal(data, &varCsrPublishHrefHints)
