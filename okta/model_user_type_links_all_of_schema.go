...
// UserTypeLinksAllOfSchema struct for UserTypeLinksAllOfSchema
type UserTypeLinksAllOfSchema struct {
...
type _UserTypeLinksAllOfSchema UserTypeLinksAllOfSchema
...
func (o UserTypeLinksAllOfSchema) MarshalJSON() ([]byte, error) {
...
func (o *UserTypeLinksAllOfSchema) UnmarshalJSON(bytes []byte) (err error) {
	varUserTypeLinksAllOfSchema := _UserTypeLinksAllOfSchema{}

	err = json.Unmarshal(bytes, &varUserTypeLinksAllOfSchema)
	if err == nil {
		*o = UserTypeLinksAllOfSchema(varUserTypeLinksAllOfSchema)
	} else {
		return err
	}
...
type NullableUserTypeLinksAllOfSchema struct {
	value *UserTypeLinksAllOfSchema
	isSet bool
}

func (v NullableUserTypeLinksAllOfSchema) Get() *UserTypeLinksAllOfSchema {
	return v.value
}

func (v *NullableUserTypeLinksAllOfSchema) Set(val *UserTypeLinksAllOfSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableUserTypeLinksAllOfSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableUserTypeLinksAllOfSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserTypeLinksAllOfSchema(val *UserTypeLinksAllOfSchema) *NullableUserTypeLinksAllOfSchema {
	return &NullableUserTypeLinksAllOfSchema{value: val, isSet: true}
}

func (v NullableUserTypeLinksAllOfSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserTypeLinksAllOfSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
