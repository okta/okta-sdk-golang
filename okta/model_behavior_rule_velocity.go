...
// checks if the BehaviorRuleVelocity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BehaviorRuleVelocity{}
...
func (o BehaviorRuleVelocity) ToMap() (map[string]interface{}, error) {
...
func (o *BehaviorRuleVelocity) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varBehaviorRuleVelocityWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varBehaviorRuleVelocity)
	if err == nil {
