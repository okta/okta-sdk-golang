...
type AuthenticatorMethodPushAllOfSettings struct {
	Algorithms           []AuthenticatorMethodAlgorithm       `json:"algorithms,omitempty"`
	KeyProtection        *PushMethodKeyProtection             `json:"keyProtection,omitempty"`
	TransactionTypes     []AuthenticatorMethodTransactionType `json:"transactionTypes,omitempty"`
...
func (o *AuthenticatorMethodPushAllOfSettings) GetAlgorithms() []AuthenticatorMethodAlgorithm {
	if o == nil || o.Algorithms == nil {
		var ret []AuthenticatorMethodAlgorithm
		return ret
	}
	return o.Algorithms
}
...
// SetAlgorithms gets a reference to the given []AuthenticatorMethodAlgorithm and assigns it to the Algorithms field.
...
func (o *AuthenticatorMethodPushAllOfSettings) GetKeyProtection() PushMethodKeyProtection {
	if o == nil || o.KeyProtection == nil {
		var ret PushMethodKeyProtection
		return ret
	}
...
// SetKeyProtection gets a reference to the given PushMethodKeyProtection and assigns it to the KeyProtection field.
...
func (o *AuthenticatorMethodPushAllOfSettings) GetTransactionTypes() []AuthenticatorMethodTransactionType {
	if o == nil || o.TransactionTypes == nil {
		var ret []AuthenticatorMethodTransactionType
		return ret
	}
...
// SetTransactionTypes gets a reference to the given []AuthenticatorMethodTransactionType and assigns it to the TransactionTypes field.
