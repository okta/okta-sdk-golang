...
type Saml struct {
	// List of Assertion Consumer Service (ACS) URLs. The default ACS URL is required and is indicated by a null index value. You can use the org properties you defined in the `config` array as variables in the URL. For example: `https://${org.subdomain}.example.com/saml/login`
	Acs []SamlAcsInner `json:"acs"`
	// The URL to your customer-facing instructions for configuring your SAML integration
	Doc string `json:"doc"`
