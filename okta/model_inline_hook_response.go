...
// checks if the InlineHookResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineHookResponse{}
...
func (o InlineHookResponse) ToMap() (map[string]interface{}, error) {
...
func (o *InlineHookResponse) UnmarshalJSON(data []byte) (err error) {
	varInlineHookResponse := _InlineHookResponse{}

	err = json.Unmarshal(data, &varInlineHookResponse)
