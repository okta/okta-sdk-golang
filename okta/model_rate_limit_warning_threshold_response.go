...
// checks if the RateLimitWarningThresholdResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RateLimitWarningThresholdResponse{}
...
func (o RateLimitWarningThresholdResponse) ToMap() (map[string]interface{}, error) {
...
func (o *RateLimitWarningThresholdResponse) UnmarshalJSON(data []byte) (err error) {
	varRateLimitWarningThresholdResponse := _RateLimitWarningThresholdResponse{}

	err = json.Unmarshal(data, &varRateLimitWarningThresholdResponse)
