...
> **Note:** This endpoint supports partial updates.
	...
	*/
	...
	//  @return ListFeaturesForApplication200ResponseInner
	UpdateFeatureForApplicationExecute(r ApiUpdateFeatureForApplicationRequest) (*ListFeaturesForApplication200ResponseInner, *APIResponse, error)
}
...
func (r ApiListFeaturesForApplicationRequest) Execute() ([]ListFeaturesForApplication200ResponseInner, *APIResponse, error) {
...
func (r ApiUpdateFeatureForApplicationRequest) Execute() (*ListFeaturesForApplication200ResponseInner, *APIResponse, error) {
...
func (a *ApplicationFeaturesAPIService) UpdateFeatureForApplicationExecute(r ApiUpdateFeatureForApplicationRequest) (*ListFeaturesForApplication200ResponseInner, *APIResponse, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.updateFeatureForApplicationRequest == nil {
		return localVarReturnValue, nil, reportError("updateFeatureForApplicationRequest is required and must be specified")
	}
