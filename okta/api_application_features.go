...
//
//	@return ApplicationFeature
func (a *ApplicationFeaturesAPIService) GetFeatureForApplicationExecute(r ApiGetFeatureForApplicationRequest) (*ApplicationFeature, *APIResponse, error) {
	var (
...
//
//	@return []ApplicationFeature
func (a *ApplicationFeaturesAPIService) ListFeaturesForApplicationExecute(r ApiListFeaturesForApplicationRequest) ([]ApplicationFeature, *APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
//
//	@return ApplicationFeature
func (a *ApplicationFeaturesAPIService) UpdateFeatureForApplicationExecute(r ApiUpdateFeatureForApplicationRequest) (*ApplicationFeature, *APIResponse, error) {
	var (
