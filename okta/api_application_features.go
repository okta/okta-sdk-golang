...
type ApplicationFeaturesAPI interface {
	...
	*/
	GetFeatureForApplication(ctx context.Context, appId string, featureName ApplicationFeatureType) ApiGetFeatureForApplicationRequest
	...
	*/
	UpdateFeatureForApplication(ctx context.Context, appId string, featureName ApplicationFeatureType) ApiUpdateFeatureForApplicationRequest
...
type ApiGetFeatureForApplicationRequest struct {
	...
	appId       string
	featureName ApplicationFeatureType
	retryCount  int32
}
...
Retrieves a Feature object for an application
	...
	@return ApiGetFeatureForApplicationRequest
*/
func (a *ApplicationFeaturesAPIService) GetFeatureForApplication(ctx context.Context, appId string, featureName ApplicationFeatureType) ApiGetFeatureForApplicationRequest {
	return ApiGetFeatureForApplicationRequest{
		ApiService:  a,
		ctx:         ctx,
		appId:       appId,
...
> **Note:** This endpoint supports partial updates.
	...
	@return ApiUpdateFeatureForApplicationRequest
*/
func (a *ApplicationFeaturesAPIService) UpdateFeatureForApplication(ctx context.Context, appId string, featureName ApplicationFeatureType) ApiUpdateFeatureForApplicationRequest {
	return ApiUpdateFeatureForApplicationRequest{
		ApiService:  a,
		ctx:         ctx,
		appId:       appId,
