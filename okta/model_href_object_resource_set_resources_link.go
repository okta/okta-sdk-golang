...
// checks if the HrefObjectResourceSetResourcesLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HrefObjectResourceSetResourcesLink{}

// HrefObjectResourceSetResourcesLink Link to resource set resources
type HrefObjectResourceSetResourcesLink struct {
...
type _HrefObjectResourceSetResourcesLink HrefObjectResourceSetResourcesLink
...
func NewHrefObjectResourceSetResourcesLink(href string) *HrefObjectResourceSetResourcesLink {
	this := HrefObjectResourceSetResourcesLink{}
	this.Href = href
	return &this
}
...
func (o HrefObjectResourceSetResourcesLink) MarshalJSON() ([]byte, error) {
...
func (o HrefObjectResourceSetResourcesLink) ToMap() (map[string]interface{}, error) {
...
func (o *HrefObjectResourceSetResourcesLink) UnmarshalJSON(data []byte) (err error) {
	...
	varHrefObjectResourceSetResourcesLink := _HrefObjectResourceSetResourcesLink{}

	err = json.Unmarshal(data, &varHrefObjectResourceSetResourcesLink)

	if err != nil {
		return err
	}

	*o = HrefObjectResourceSetResourcesLink(varHrefObjectResourceSetResourcesLink)
...
type NullableHrefObjectResourceSetResourcesLink struct {
	value *HrefObjectResourceSetResourcesLink
	isSet bool
}

func (v NullableHrefObjectResourceSetResourcesLink) Get() *HrefObjectResourceSetResourcesLink {
	return v.value
}

func (v *NullableHrefObjectResourceSetResourcesLink) Set(val *HrefObjectResourceSetResourcesLink) {
	v.value = val
	v.isSet = true
}

func (v NullableHrefObjectResourceSetResourcesLink) IsSet() bool {
	return v.isSet
}

func (v *NullableHrefObjectResourceSetResourcesLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHrefObjectResourceSetResourcesLink(val *HrefObjectResourceSetResourcesLink) *NullableHrefObjectResourceSetResourcesLink {
	return &NullableHrefObjectResourceSetResourcesLink{value: val, isSet: true}
}

func (v NullableHrefObjectResourceSetResourcesLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHrefObjectResourceSetResourcesLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
