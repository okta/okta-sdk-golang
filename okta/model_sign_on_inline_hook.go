...
// checks if the SignOnInlineHook type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SignOnInlineHook{}
...
func (o SignOnInlineHook) ToMap() (map[string]interface{}, error) {
...
func (o *SignOnInlineHook) UnmarshalJSON(data []byte) (err error) {
	varSignOnInlineHook := _SignOnInlineHook{}

	err = json.Unmarshal(data, &varSignOnInlineHook)
