...
type ApiTokenAPI interface {
	...
	*/
	...
	// UpsertApiTokenExecute executes the request
	//  @return ApiToken
	UpsertApiTokenExecute(r ApiUpsertApiTokenRequest) (*ApiToken, *APIResponse, error)
}
...
func (r ApiUpsertApiTokenRequest) Execute() (*ApiToken, *APIResponse, error) {
	return r.ApiService.UpsertApiTokenExecute(r)
}
...
func (a *ApiTokenAPIService) UpsertApiTokenExecute(r ApiUpsertApiTokenRequest) (*ApiToken, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApiTokenAPIService.UpsertApiToken")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	if r.apiTokenUpdate == nil {
		return localVarReturnValue, nil, reportError("apiTokenUpdate is required and must be specified")
	}
