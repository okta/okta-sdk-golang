...
// checks if the HrefObjectGroupLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HrefObjectGroupLink{}

// HrefObjectGroupLink Link to the group resource
...
func (o HrefObjectGroupLink) ToMap() (map[string]interface{}, error) {
...
func (o *HrefObjectGroupLink) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHrefObjectGroupLink)
