...
func (o *UserFactorPushTransactionTimeoutAllOfLinks) UnmarshalJSON(bytes []byte) (err error) {
	type UserFactorPushTransactionTimeoutAllOfLinksWithoutEmbeddedStruct struct {
		Verify *HrefObject `json:"verify,omitempty"`
	}

	varUserFactorPushTransactionTimeoutAllOfLinksWithoutEmbeddedStruct := UserFactorPushTransactionTimeoutAllOfLinksWithoutEmbeddedStruct{}

	err = json.Unmarshal(bytes, &varUserFactorPushTransactionTimeoutAllOfLinksWithoutEmbeddedStruct)
	if err == nil {
		varUserFactorPushTransactionTimeoutAllOfLinks := _UserFactorPushTransactionTimeoutAllOfLinks{}
		varUserFactorPushTransactionTimeoutAllOfLinks.Verify = varUserFactorPushTransactionTimeoutAllOfLinksWithoutEmbeddedStruct.Verify
	...
	if err == nil {
		o.UserFactor = varUserFactorPushTransactionTimeoutAllOfLinks.UserFactor
	} else {
		return err
	}
