...
// checks if the SamlSpCertificate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SamlSpCertificate{}
...
func (o SamlSpCertificate) ToMap() (map[string]interface{}, error) {
...
func (o *SamlSpCertificate) UnmarshalJSON(data []byte) (err error) {
	varSamlSpCertificate := _SamlSpCertificate{}

	err = json.Unmarshal(data, &varSamlSpCertificate)
