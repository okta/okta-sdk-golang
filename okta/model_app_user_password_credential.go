...
// checks if the AppUserPasswordCredential type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppUserPasswordCredential{}
...
func (o AppUserPasswordCredential) ToMap() (map[string]interface{}, error) {
...
func (o *AppUserPasswordCredential) UnmarshalJSON(data []byte) (err error) {
	varAppUserPasswordCredential := _AppUserPasswordCredential{}

	err = json.Unmarshal(data, &varAppUserPasswordCredential)
