...
// checks if the UserSchemaProperties type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserSchemaProperties{}
...
func (o UserSchemaProperties) ToMap() (map[string]interface{}, error) {
...
func (o *UserSchemaProperties) UnmarshalJSON(data []byte) (err error) {
	varUserSchemaProperties := _UserSchemaProperties{}

	err = json.Unmarshal(data, &varUserSchemaProperties)
