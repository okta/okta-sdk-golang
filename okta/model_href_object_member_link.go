...
// checks if the HrefObjectMemberLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HrefObjectMemberLink{}

// HrefObjectMemberLink Link to the member resource
type HrefObjectMemberLink struct {
...
type _HrefObjectMemberLink HrefObjectMemberLink
...
func (o HrefObjectMemberLink) MarshalJSON() ([]byte, error) {
...
func (o HrefObjectMemberLink) ToMap() (map[string]interface{}, error) {
...
func (o *HrefObjectMemberLink) UnmarshalJSON(data []byte) (err error) {
	...
	varHrefObjectMemberLink := _HrefObjectMemberLink{}

	err = json.Unmarshal(data, &varHrefObjectMemberLink)

	if err != nil {
		return err
	}

	*o = HrefObjectMemberLink(varHrefObjectMemberLink)
...
type NullableHrefObjectMemberLink struct {
	value *HrefObjectMemberLink
	isSet bool
}

func (v NullableHrefObjectMemberLink) Get() *HrefObjectMemberLink {
	return v.value
}

func (v *NullableHrefObjectMemberLink) Set(val *HrefObjectMemberLink) {
	v.value = val
	v.isSet = true
}

func (v NullableHrefObjectMemberLink) IsSet() bool {
	return v.isSet
}

func (v *NullableHrefObjectMemberLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHrefObjectMemberLink(val *HrefObjectMemberLink) *NullableHrefObjectMemberLink {
	return &NullableHrefObjectMemberLink{value: val, isSet: true}
}

func (v NullableHrefObjectMemberLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHrefObjectMemberLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
