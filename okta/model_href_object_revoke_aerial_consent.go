...
// checks if the HrefObjectRevokeAerialConsent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HrefObjectRevokeAerialConsent{}

// HrefObjectRevokeAerialConsent Link to revoke Okta Aerial consent for your Org
type HrefObjectRevokeAerialConsent struct {
...
type _HrefObjectRevokeAerialConsent HrefObjectRevokeAerialConsent
...
func NewHrefObjectRevokeAerialConsent(href string) *HrefObjectRevokeAerialConsent {
	this := HrefObjectRevokeAerialConsent{}
	this.Href = href
	return &this
}
...
func (o HrefObjectRevokeAerialConsent) MarshalJSON() ([]byte, error) {
...
func (o HrefObjectRevokeAerialConsent) ToMap() (map[string]interface{}, error) {
...
func (o *HrefObjectRevokeAerialConsent) UnmarshalJSON(data []byte) (err error) {
	...
	varHrefObjectRevokeAerialConsent := _HrefObjectRevokeAerialConsent{}

	err = json.Unmarshal(data, &varHrefObjectRevokeAerialConsent)

	if err != nil {
		return err
	}

	*o = HrefObjectRevokeAerialConsent(varHrefObjectRevokeAerialConsent)
...
type NullableHrefObjectRevokeAerialConsent struct {
	value *HrefObjectRevokeAerialConsent
	isSet bool
}

func (v NullableHrefObjectRevokeAerialConsent) Get() *HrefObjectRevokeAerialConsent {
	return v.value
}

func (v *NullableHrefObjectRevokeAerialConsent) Set(val *HrefObjectRevokeAerialConsent) {
	v.value = val
	v.isSet = true
}

func (v NullableHrefObjectRevokeAerialConsent) IsSet() bool {
	return v.isSet
}

func (v *NullableHrefObjectRevokeAerialConsent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHrefObjectRevokeAerialConsent(val *HrefObjectRevokeAerialConsent) *NullableHrefObjectRevokeAerialConsent {
	return &NullableHrefObjectRevokeAerialConsent{value: val, isSet: true}
}

func (v NullableHrefObjectRevokeAerialConsent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHrefObjectRevokeAerialConsent) UnmarshalJSON(src []byte) error {
	v.isSet = true
