...
func (m *FactorResource) DeleteFactor(userId string, factorId string)  {
...
func (m *FactorResource) ActivateFactor(userId string, factorId string, body VerifyFactorRequest)  *Factor {
...
func (m *FactorResource) VerifyFactor(userId string, factorId string, body VerifyFactorRequest)  *VerifyFactorResponse {
	iobytes, err := json.Marshal(body)
	if err != nil  {
		fmt.Printf("error: %v", err)
	}
