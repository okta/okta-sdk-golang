...
func (o ZoomUsApplication) ToMap() (map[string]interface{}, error) {
...
func (o *ZoomUsApplication) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varZoomUsApplication)
