...
type RealmAPI interface {
	...
	*/
	...
	//  @return Realm
	ReplaceRealmExecute(r ApiReplaceRealmRequest) (*Realm, *APIResponse, error)
}
...
func (r ApiCreateRealmRequest) Execute() (*Realm, *APIResponse, error) {
...
func (r ApiGetRealmRequest) Execute() (*Realm, *APIResponse, error) {
...
func (r ApiListRealmsRequest) Execute() ([]Realm, *APIResponse, error) {
...
func (r ApiReplaceRealmRequest) Execute() (*Realm, *APIResponse, error) {
