...
type RealmApi interface {
	...
	*/
	UpdateRealm(ctx context.Context, realmId string) ApiUpdateRealmRequest

	// UpdateRealmExecute executes the request
	//  @return Realm
	UpdateRealmExecute(r ApiUpdateRealmRequest) (*Realm, *APIResponse, error)
}
...
func (r ApiCreateRealmRequest) Body(body Realm) ApiCreateRealmRequest {
	r.body = &body
	return r
}
...
func (r ApiUpdateRealmRequest) Body(body Realm) ApiUpdateRealmRequest {
	r.body = &body
	return r
}

func (r ApiUpdateRealmRequest) Execute() (*Realm, *APIResponse, error) {
	return r.ApiService.UpdateRealmExecute(r)
}
...
Updates a Realm
	...
	@return ApiUpdateRealmRequest
*/
func (a *RealmApiService) UpdateRealm(ctx context.Context, realmId string) ApiUpdateRealmRequest {
	return ApiUpdateRealmRequest{
		ApiService: a,
		ctx:        ctx,
		realmId:    realmId,
...
//
//	@return Realm
func (a *RealmApiService) UpdateRealmExecute(r ApiUpdateRealmRequest) (*Realm, *APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RealmApiService.UpdateRealm")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
