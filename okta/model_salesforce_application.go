...
func (o SalesforceApplication) ToMap() (map[string]interface{}, error) {
...
func (o *SalesforceApplication) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSalesforceApplication)
