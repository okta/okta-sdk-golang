...
// checks if the HrefObjectGrantAerialConsent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HrefObjectGrantAerialConsent{}

// HrefObjectGrantAerialConsent Link to grant Okta Aerial access to your Org
type HrefObjectGrantAerialConsent struct {
...
type _HrefObjectGrantAerialConsent HrefObjectGrantAerialConsent
...
func NewHrefObjectGrantAerialConsent(href string) *HrefObjectGrantAerialConsent {
	this := HrefObjectGrantAerialConsent{}
	this.Href = href
	return &this
}
...
func (o HrefObjectGrantAerialConsent) MarshalJSON() ([]byte, error) {
...
func (o HrefObjectGrantAerialConsent) ToMap() (map[string]interface{}, error) {
...
func (o *HrefObjectGrantAerialConsent) UnmarshalJSON(data []byte) (err error) {
	...
	varHrefObjectGrantAerialConsent := _HrefObjectGrantAerialConsent{}

	err = json.Unmarshal(data, &varHrefObjectGrantAerialConsent)

	if err != nil {
		return err
	}

	*o = HrefObjectGrantAerialConsent(varHrefObjectGrantAerialConsent)
...
type NullableHrefObjectGrantAerialConsent struct {
	value *HrefObjectGrantAerialConsent
	isSet bool
}

func (v NullableHrefObjectGrantAerialConsent) Get() *HrefObjectGrantAerialConsent {
	return v.value
}

func (v *NullableHrefObjectGrantAerialConsent) Set(val *HrefObjectGrantAerialConsent) {
	v.value = val
	v.isSet = true
}

func (v NullableHrefObjectGrantAerialConsent) IsSet() bool {
	return v.isSet
}

func (v *NullableHrefObjectGrantAerialConsent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHrefObjectGrantAerialConsent(val *HrefObjectGrantAerialConsent) *NullableHrefObjectGrantAerialConsent {
	return &NullableHrefObjectGrantAerialConsent{value: val, isSet: true}
}

func (v NullableHrefObjectGrantAerialConsent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHrefObjectGrantAerialConsent) UnmarshalJSON(src []byte) error {
	v.isSet = true
