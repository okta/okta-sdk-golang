...
// checks if the HrefObjectClientLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HrefObjectClientLink{}

// HrefObjectClientLink Link to the client resource
type HrefObjectClientLink struct {
...
type _HrefObjectClientLink HrefObjectClientLink
...
func (o HrefObjectClientLink) MarshalJSON() ([]byte, error) {
...
func (o HrefObjectClientLink) ToMap() (map[string]interface{}, error) {
...
func (o *HrefObjectClientLink) UnmarshalJSON(data []byte) (err error) {
	...
	varHrefObjectClientLink := _HrefObjectClientLink{}

	err = json.Unmarshal(data, &varHrefObjectClientLink)

	if err != nil {
		return err
	}

	*o = HrefObjectClientLink(varHrefObjectClientLink)
...
type NullableHrefObjectClientLink struct {
	value *HrefObjectClientLink
	isSet bool
}

func (v NullableHrefObjectClientLink) Get() *HrefObjectClientLink {
	return v.value
}

func (v *NullableHrefObjectClientLink) Set(val *HrefObjectClientLink) {
	v.value = val
	v.isSet = true
}

func (v NullableHrefObjectClientLink) IsSet() bool {
	return v.isSet
}

func (v *NullableHrefObjectClientLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHrefObjectClientLink(val *HrefObjectClientLink) *NullableHrefObjectClientLink {
	return &NullableHrefObjectClientLink{value: val, isSet: true}
}

func (v NullableHrefObjectClientLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHrefObjectClientLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
