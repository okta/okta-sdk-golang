...
// checks if the SimulatePolicyEvaluationsEvaluated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SimulatePolicyEvaluationsEvaluated{}
...
func (o SimulatePolicyEvaluationsEvaluated) ToMap() (map[string]interface{}, error) {
...
func (o *SimulatePolicyEvaluationsEvaluated) UnmarshalJSON(data []byte) (err error) {
	varSimulatePolicyEvaluationsEvaluated := _SimulatePolicyEvaluationsEvaluated{}

	err = json.Unmarshal(data, &varSimulatePolicyEvaluationsEvaluated)
