...
type OrgCAPTCHASettings struct {
	...
	EnabledPages         []EnabledPagesType       `json:"enabledPages,omitempty"`
...
// SetEnabledPages gets a reference to the given []EnabledPagesType and assigns it to the EnabledPages field.
