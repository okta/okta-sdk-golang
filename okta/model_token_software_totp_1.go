...
// checks if the TokenSoftwareTotp1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TokenSoftwareTotp1{}
...
func (o TokenSoftwareTotp1) ToMap() (map[string]interface{}, error) {
...
func (o *TokenSoftwareTotp1) UnmarshalJSON(data []byte) (err error) {
	varTokenSoftwareTotp1 := _TokenSoftwareTotp1{}

	err = json.Unmarshal(data, &varTokenSoftwareTotp1)
