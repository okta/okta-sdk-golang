...
// checks if the AuthenticatorKeyPhoneAllOfSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthenticatorKeyPhoneAllOfSettings{}
...
func (o AuthenticatorKeyPhoneAllOfSettings) ToMap() (map[string]interface{}, error) {
...
func (o *AuthenticatorKeyPhoneAllOfSettings) UnmarshalJSON(data []byte) (err error) {
	varAuthenticatorKeyPhoneAllOfSettings := _AuthenticatorKeyPhoneAllOfSettings{}

	err = json.Unmarshal(data, &varAuthenticatorKeyPhoneAllOfSettings)
