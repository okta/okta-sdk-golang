...
func NewOAuth2Scope() *OAuth2Scope {
	this := OAuth2Scope{}
	var consent OAuth2ScopeConsentType = OAUTH2SCOPECONSENTTYPE_IMPLICIT
	this.Consent = &consent
	var metadataPublish OAuth2ScopeMetadataPublish = OAUTH2SCOPEMETADATAPUBLISH_NO_CLIENTS
