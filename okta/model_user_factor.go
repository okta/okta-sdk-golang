...
type UserFactor struct {
	...
	FactorType *UserFactorType `json:"factorType,omitempty"`
	// ID of the Factor
	...
	Provider *UserFactorProvider    `json:"provider,omitempty"`
	Status   *UserFactorStatus      `json:"status,omitempty"`
...
// SetFactorType gets a reference to the given UserFactorType and assigns it to the FactorType field.
...
// SetProvider gets a reference to the given UserFactorProvider and assigns it to the Provider field.
...
// SetStatus gets a reference to the given UserFactorStatus and assigns it to the Status field.
