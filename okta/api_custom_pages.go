...
func (a *CustomPagesAPIService) DeleteCustomizedErrorPageExecute(r ApiDeleteCustomizedErrorPageRequest) (*APIResponse, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomPagesAPIService.DeleteCustomizedErrorPage")
	if err != nil {
...
// Execute executes the request
func (a *CustomPagesAPIService) DeleteCustomizedSignInPageExecute(r ApiDeleteCustomizedSignInPageRequest) (*APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomPagesAPIService.DeleteCustomizedSignInPage")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// Execute executes the request
func (a *CustomPagesAPIService) DeletePreviewErrorPageExecute(r ApiDeletePreviewErrorPageRequest) (*APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomPagesAPIService.DeletePreviewErrorPage")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// Execute executes the request
func (a *CustomPagesAPIService) DeletePreviewSignInPageExecute(r ApiDeletePreviewSignInPageRequest) (*APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomPagesAPIService.DeletePreviewSignInPage")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *CustomPagesAPIService) GetCustomizedErrorPageExecute(r ApiGetCustomizedErrorPageRequest) (*ErrorPage, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomPagesAPIService.GetCustomizedErrorPage")
	if err != nil {
...
func (a *CustomPagesAPIService) GetCustomizedSignInPageExecute(r ApiGetCustomizedSignInPageRequest) (*SignInPage, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomPagesAPIService.GetCustomizedSignInPage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *CustomPagesAPIService) GetDefaultErrorPageExecute(r ApiGetDefaultErrorPageRequest) (*ErrorPage, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomPagesAPIService.GetDefaultErrorPage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *CustomPagesAPIService) GetDefaultSignInPageExecute(r ApiGetDefaultSignInPageRequest) (*SignInPage, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomPagesAPIService.GetDefaultSignInPage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *CustomPagesAPIService) GetErrorPageExecute(r ApiGetErrorPageRequest) (*PageRoot, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomPagesAPIService.GetErrorPage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *CustomPagesAPIService) GetPreviewErrorPageExecute(r ApiGetPreviewErrorPageRequest) (*ErrorPage, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomPagesAPIService.GetPreviewErrorPage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *CustomPagesAPIService) GetPreviewSignInPageExecute(r ApiGetPreviewSignInPageRequest) (*SignInPage, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomPagesAPIService.GetPreviewSignInPage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *CustomPagesAPIService) GetSignInPageExecute(r ApiGetSignInPageRequest) (*PageRoot, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomPagesAPIService.GetSignInPage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *CustomPagesAPIService) GetSignOutPageSettingsExecute(r ApiGetSignOutPageSettingsRequest) (*HostedPage, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomPagesAPIService.GetSignOutPageSettings")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *CustomPagesAPIService) ListAllSignInWidgetVersionsExecute(r ApiListAllSignInWidgetVersionsRequest) ([]string, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomPagesAPIService.ListAllSignInWidgetVersions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *CustomPagesAPIService) ReplaceCustomizedErrorPageExecute(r ApiReplaceCustomizedErrorPageRequest) (*ErrorPage, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomPagesAPIService.ReplaceCustomizedErrorPage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *CustomPagesAPIService) ReplaceCustomizedSignInPageExecute(r ApiReplaceCustomizedSignInPageRequest) (*SignInPage, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomPagesAPIService.ReplaceCustomizedSignInPage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *CustomPagesAPIService) ReplacePreviewErrorPageExecute(r ApiReplacePreviewErrorPageRequest) (*ErrorPage, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomPagesAPIService.ReplacePreviewErrorPage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *CustomPagesAPIService) ReplacePreviewSignInPageExecute(r ApiReplacePreviewSignInPageRequest) (*SignInPage, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomPagesAPIService.ReplacePreviewSignInPage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *CustomPagesAPIService) ReplaceSignOutPageSettingsExecute(r ApiReplaceSignOutPageSettingsRequest) (*HostedPage, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomPagesAPIService.ReplaceSignOutPageSettings")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
