...
func (m *GroupRuleResource) UpdateRule(ruleId string, body GroupRule)  *GroupRule {
...
func (m *GroupRuleResource) DeleteRule(ruleId string)  {
...
func (m *GroupRuleResource) ActivateRule(ruleId string)  {
	_, err := m.client.requestExecutor.Post("/api/v1/groups/rules/"+ruleId+"/lifecycle/activate", nil)
	if err != nil  {
		fmt.Printf("error: %v", err)
	}
}
func (m *GroupRuleResource) DeactivateRule(ruleId string)  {
