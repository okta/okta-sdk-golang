...
// checks if the EmailTestAddresses type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmailTestAddresses{}
...
func (o *EmailTestAddresses) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varEmailTestAddresses)
