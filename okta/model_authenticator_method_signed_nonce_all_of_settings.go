...
type AuthenticatorMethodSignedNonceAllOfSettings struct {
	...
	ShowSignInWithOV     *ShowSignInWithOV              `json:"showSignInWithOV,omitempty"`
...
// SetShowSignInWithOV gets a reference to the given ShowSignInWithOV and assigns it to the ShowSignInWithOV field.
