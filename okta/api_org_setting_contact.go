...
type OrgSettingContactAPI interface {
	...
	*/
	...
	// ListOrgContactTypesExecute executes the request
...
// OrgSettingContactAPIService OrgSettingContactAPI service
...
func (a *OrgSettingContactAPIService) GetOrgContactUserExecute(r ApiGetOrgContactUserRequest) (*OrgContactUser, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrgSettingContactAPIService.GetOrgContactUser")
	if err != nil {
...
func (r ApiListOrgContactTypesRequest) Execute() ([]ListOrgContactTypes200ResponseInner, *APIResponse, error) {
	return r.ApiService.ListOrgContactTypesExecute(r)
}
...
func (a *OrgSettingContactAPIService) ListOrgContactTypesExecute(r ApiListOrgContactTypesRequest) ([]ListOrgContactTypes200ResponseInner, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrgSettingContactAPIService.ListOrgContactTypes")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *OrgSettingContactAPIService) ReplaceOrgContactUserExecute(r ApiReplaceOrgContactUserRequest) (*OrgContactUser, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrgSettingContactAPIService.ReplaceOrgContactUser")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
