...
// checks if the Saml11ApplicationSettingsSignOn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Saml11ApplicationSettingsSignOn{}
...
func (o Saml11ApplicationSettingsSignOn) ToMap() (map[string]interface{}, error) {
...
func (o *Saml11ApplicationSettingsSignOn) UnmarshalJSON(data []byte) (err error) {
	varSaml11ApplicationSettingsSignOn := _Saml11ApplicationSettingsSignOn{}

	err = json.Unmarshal(data, &varSaml11ApplicationSettingsSignOn)
