...
type _LinksResendResend LinksResendResend
...
func (o LinksResendResend) MarshalJSON() ([]byte, error) {
...
func (o *LinksResendResend) UnmarshalJSON(bytes []byte) (err error) {
	varLinksResendResend := _LinksResendResend{}

	err = json.Unmarshal(bytes, &varLinksResendResend)
	if err == nil {
		*o = LinksResendResend(varLinksResendResend)
	} else {
		return err
	}
...
type NullableLinksResendResend struct {
	value *LinksResendResend
	isSet bool
}

func (v NullableLinksResendResend) Get() *LinksResendResend {
	return v.value
}

func (v *NullableLinksResendResend) Set(val *LinksResendResend) {
	v.value = val
	v.isSet = true
}

func (v NullableLinksResendResend) IsSet() bool {
	return v.isSet
}

func (v *NullableLinksResendResend) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinksResendResend(val *LinksResendResend) *NullableLinksResendResend {
	return &NullableLinksResendResend{value: val, isSet: true}
}

func (v NullableLinksResendResend) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinksResendResend) UnmarshalJSON(src []byte) error {
	v.isSet = true
