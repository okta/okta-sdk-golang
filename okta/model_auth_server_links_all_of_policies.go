...
type AuthServerLinksAllOfPolicies struct {
...
type _AuthServerLinksAllOfPolicies AuthServerLinksAllOfPolicies
...
func NewAuthServerLinksAllOfPolicies(href string) *AuthServerLinksAllOfPolicies {
	this := AuthServerLinksAllOfPolicies{}
	this.Href = href
	return &this
}
...
func (o AuthServerLinksAllOfPolicies) MarshalJSON() ([]byte, error) {
...
func (o *AuthServerLinksAllOfPolicies) UnmarshalJSON(bytes []byte) (err error) {
	varAuthServerLinksAllOfPolicies := _AuthServerLinksAllOfPolicies{}

	err = json.Unmarshal(bytes, &varAuthServerLinksAllOfPolicies)
	if err == nil {
		*o = AuthServerLinksAllOfPolicies(varAuthServerLinksAllOfPolicies)
	} else {
		return err
	}
...
type NullableAuthServerLinksAllOfPolicies struct {
	value *AuthServerLinksAllOfPolicies
	isSet bool
}

func (v NullableAuthServerLinksAllOfPolicies) Get() *AuthServerLinksAllOfPolicies {
	return v.value
}

func (v *NullableAuthServerLinksAllOfPolicies) Set(val *AuthServerLinksAllOfPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthServerLinksAllOfPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableAuthServerLinksAllOfPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuthServerLinksAllOfPolicies(val *AuthServerLinksAllOfPolicies) *NullableAuthServerLinksAllOfPolicies {
	return &NullableAuthServerLinksAllOfPolicies{value: val, isSet: true}
}

func (v NullableAuthServerLinksAllOfPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuthServerLinksAllOfPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
