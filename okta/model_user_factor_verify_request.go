...
// map[string]interface{}AsUserFactorVerifyRequest is a convenience function that returns map[string]interface{} wrapped in UserFactorVerifyRequest
func MapmapOfStringAnyAsUserFactorVerifyRequest(v *map[string]interface{}) UserFactorVerifyRequest {
	return UserFactorVerifyRequest{
		MapmapOfStringAny: v,
	}
}
