...
// checks if the HrefObjectMappingsLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HrefObjectMappingsLink{}

// HrefObjectMappingsLink Link to the mappings resource
type HrefObjectMappingsLink struct {
...
type _HrefObjectMappingsLink HrefObjectMappingsLink
...
func (o HrefObjectMappingsLink) MarshalJSON() ([]byte, error) {
...
func (o HrefObjectMappingsLink) ToMap() (map[string]interface{}, error) {
...
func (o *HrefObjectMappingsLink) UnmarshalJSON(data []byte) (err error) {
	...
	varHrefObjectMappingsLink := _HrefObjectMappingsLink{}

	err = json.Unmarshal(data, &varHrefObjectMappingsLink)

	if err != nil {
		return err
	}

	*o = HrefObjectMappingsLink(varHrefObjectMappingsLink)
...
type NullableHrefObjectMappingsLink struct {
	value *HrefObjectMappingsLink
	isSet bool
}

func (v NullableHrefObjectMappingsLink) Get() *HrefObjectMappingsLink {
	return v.value
}

func (v *NullableHrefObjectMappingsLink) Set(val *HrefObjectMappingsLink) {
	v.value = val
	v.isSet = true
}

func (v NullableHrefObjectMappingsLink) IsSet() bool {
	return v.isSet
}

func (v *NullableHrefObjectMappingsLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHrefObjectMappingsLink(val *HrefObjectMappingsLink) *NullableHrefObjectMappingsLink {
	return &NullableHrefObjectMappingsLink{value: val, isSet: true}
}

func (v NullableHrefObjectMappingsLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHrefObjectMappingsLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
