...
type OAuth2ScopeConsentGrantLinks struct {
	...
	App                  *HrefObject         `json:"app,omitempty"`
	Client               *HrefObject         `json:"client,omitempty"`
...
// SetApp gets a reference to the given HrefObject and assigns it to the App field.
...
// SetClient gets a reference to the given HrefObject and assigns it to the Client field.
