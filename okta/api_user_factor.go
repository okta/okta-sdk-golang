...
type UserFactorAPI interface {
	...
	*/
	...
	GetFactorTransactionStatusExecute(r ApiGetFactorTransactionStatusRequest) (*UserFactorVerifyResponse, *APIResponse, error)
	...
	*/
	...
	//  @return ListFactors200ResponseInner
	ResendEnrollFactorExecute(r ApiResendEnrollFactorRequest) (*ListFactors200ResponseInner, *APIResponse, error)
...
func (r ApiGetFactorTransactionStatusRequest) Execute() (*UserFactorVerifyResponse, *APIResponse, error) {
...
//
//	@return UserFactorVerifyResponse
func (a *UserFactorAPIService) GetFactorTransactionStatusExecute(r ApiGetFactorTransactionStatusRequest) (*UserFactorVerifyResponse, *APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiResendEnrollFactorRequest) Execute() (*ListFactors200ResponseInner, *APIResponse, error) {
...
//
//	@return ListFactors200ResponseInner
func (a *UserFactorAPIService) ResendEnrollFactorExecute(r ApiResendEnrollFactorRequest) (*ListFactors200ResponseInner, *APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.listFactors200ResponseInner == nil {
		return localVarReturnValue, nil, reportError("listFactors200ResponseInner is required and must be specified")
	}
