...
// checks if the HrefObjectSelfLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HrefObjectSelfLink{}

// HrefObjectSelfLink Link to the resource (self)
...
func (o HrefObjectSelfLink) ToMap() (map[string]interface{}, error) {
...
func (o *HrefObjectSelfLink) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHrefObjectSelfLink)
