...
// checks if the HrefObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HrefObject{}
...
func (o HrefObject) ToMap() (map[string]interface{}, error) {
...
func (o *HrefObject) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHrefObject)
