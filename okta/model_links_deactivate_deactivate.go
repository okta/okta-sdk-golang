...
type LinksDeactivateDeactivate struct {
...
type _LinksDeactivateDeactivate LinksDeactivateDeactivate
...
func NewLinksDeactivateDeactivate(href string) *LinksDeactivateDeactivate {
	this := LinksDeactivateDeactivate{}
	this.Href = href
	return &this
}
...
func (o LinksDeactivateDeactivate) MarshalJSON() ([]byte, error) {
...
func (o *LinksDeactivateDeactivate) UnmarshalJSON(bytes []byte) (err error) {
	varLinksDeactivateDeactivate := _LinksDeactivateDeactivate{}

	err = json.Unmarshal(bytes, &varLinksDeactivateDeactivate)
	if err == nil {
		*o = LinksDeactivateDeactivate(varLinksDeactivateDeactivate)
	} else {
		return err
	}
...
type NullableLinksDeactivateDeactivate struct {
	value *LinksDeactivateDeactivate
	isSet bool
}

func (v NullableLinksDeactivateDeactivate) Get() *LinksDeactivateDeactivate {
	return v.value
}

func (v *NullableLinksDeactivateDeactivate) Set(val *LinksDeactivateDeactivate) {
	v.value = val
	v.isSet = true
}

func (v NullableLinksDeactivateDeactivate) IsSet() bool {
	return v.isSet
}

func (v *NullableLinksDeactivateDeactivate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinksDeactivateDeactivate(val *LinksDeactivateDeactivate) *NullableLinksDeactivateDeactivate {
	return &NullableLinksDeactivateDeactivate{value: val, isSet: true}
}

func (v NullableLinksDeactivateDeactivate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinksDeactivateDeactivate) UnmarshalJSON(src []byte) error {
	v.isSet = true
