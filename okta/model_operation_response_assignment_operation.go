...
// checks if the OperationResponseAssignmentOperation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OperationResponseAssignmentOperation{}

// OperationResponseAssignmentOperation Definition of the realm assignment operation
...
func (o OperationResponseAssignmentOperation) ToMap() (map[string]interface{}, error) {
...
func (o *OperationResponseAssignmentOperation) UnmarshalJSON(data []byte) (err error) {
	varOperationResponseAssignmentOperation := _OperationResponseAssignmentOperation{}

	err = json.Unmarshal(data, &varOperationResponseAssignmentOperation)
