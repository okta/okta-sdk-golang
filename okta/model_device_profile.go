...
type DeviceProfile struct {
	DiskEncryptionType *DiskEncryptionTypeDef `json:"diskEncryptionType,omitempty"`
...
// SetDiskEncryptionType gets a reference to the given DiskEncryptionTypeDef and assigns it to the DiskEncryptionType field.
