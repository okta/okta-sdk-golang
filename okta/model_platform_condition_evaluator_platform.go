...
// checks if the PlatformConditionEvaluatorPlatform type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PlatformConditionEvaluatorPlatform{}
...
func (o PlatformConditionEvaluatorPlatform) ToMap() (map[string]interface{}, error) {
...
func (o *PlatformConditionEvaluatorPlatform) UnmarshalJSON(data []byte) (err error) {
	varPlatformConditionEvaluatorPlatform := _PlatformConditionEvaluatorPlatform{}

	err = json.Unmarshal(data, &varPlatformConditionEvaluatorPlatform)
