...
// GoogleApplicationAllOf struct for GoogleApplicationAllOf
type GoogleApplicationAllOf struct {
...
type _GoogleApplicationAllOf GoogleApplicationAllOf
...
func (o GoogleApplicationAllOf) MarshalJSON() ([]byte, error) {
...
func (o *GoogleApplicationAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varGoogleApplicationAllOf := _GoogleApplicationAllOf{}

	err = json.Unmarshal(bytes, &varGoogleApplicationAllOf)
	if err == nil {
		*o = GoogleApplicationAllOf(varGoogleApplicationAllOf)
	} else {
		return err
	}
...
type NullableGoogleApplicationAllOf struct {
	value *GoogleApplicationAllOf
	isSet bool
}

func (v NullableGoogleApplicationAllOf) Get() *GoogleApplicationAllOf {
	return v.value
}

func (v *NullableGoogleApplicationAllOf) Set(val *GoogleApplicationAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableGoogleApplicationAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableGoogleApplicationAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGoogleApplicationAllOf(val *GoogleApplicationAllOf) *NullableGoogleApplicationAllOf {
	return &NullableGoogleApplicationAllOf{value: val, isSet: true}
}

func (v NullableGoogleApplicationAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGoogleApplicationAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
