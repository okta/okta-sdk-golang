...
// checks if the ScopeResourceHrefObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScopeResourceHrefObject{}
...
func (o ScopeResourceHrefObject) ToMap() (map[string]interface{}, error) {
...
func (o *ScopeResourceHrefObject) UnmarshalJSON(data []byte) (err error) {
	varScopeResourceHrefObject := _ScopeResourceHrefObject{}

	err = json.Unmarshal(data, &varScopeResourceHrefObject)
