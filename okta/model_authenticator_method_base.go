...
type AuthenticatorMethodBase struct {
	...
	Type                 *AuthenticatorMethodType `json:"type,omitempty"`
...
func (o *AuthenticatorMethodBase) GetType() AuthenticatorMethodType {
	if o == nil || o.Type == nil {
		var ret AuthenticatorMethodType
		return ret
	}
	return *o.Type
}
...
// SetType gets a reference to the given AuthenticatorMethodType and assigns it to the Type field.
