...
// checks if the HrefObjectResourceSetLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HrefObjectResourceSetLink{}

// HrefObjectResourceSetLink Link to the resource set resource
type HrefObjectResourceSetLink struct {
...
type _HrefObjectResourceSetLink HrefObjectResourceSetLink
...
func NewHrefObjectResourceSetLink(href string) *HrefObjectResourceSetLink {
	this := HrefObjectResourceSetLink{}
	this.Href = href
	return &this
}
...
func (o HrefObjectResourceSetLink) MarshalJSON() ([]byte, error) {
...
func (o HrefObjectResourceSetLink) ToMap() (map[string]interface{}, error) {
...
func (o *HrefObjectResourceSetLink) UnmarshalJSON(data []byte) (err error) {
	...
	varHrefObjectResourceSetLink := _HrefObjectResourceSetLink{}

	err = json.Unmarshal(data, &varHrefObjectResourceSetLink)

	if err != nil {
		return err
	}

	*o = HrefObjectResourceSetLink(varHrefObjectResourceSetLink)
...
type NullableHrefObjectResourceSetLink struct {
	value *HrefObjectResourceSetLink
	isSet bool
}

func (v NullableHrefObjectResourceSetLink) Get() *HrefObjectResourceSetLink {
	return v.value
}

func (v *NullableHrefObjectResourceSetLink) Set(val *HrefObjectResourceSetLink) {
	v.value = val
	v.isSet = true
}

func (v NullableHrefObjectResourceSetLink) IsSet() bool {
	return v.isSet
}

func (v *NullableHrefObjectResourceSetLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHrefObjectResourceSetLink(val *HrefObjectResourceSetLink) *NullableHrefObjectResourceSetLink {
	return &NullableHrefObjectResourceSetLink{value: val, isSet: true}
}

func (v NullableHrefObjectResourceSetLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHrefObjectResourceSetLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
