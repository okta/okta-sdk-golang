...
type _LinksSendSend LinksSendSend
...
func (o LinksSendSend) MarshalJSON() ([]byte, error) {
...
func (o *LinksSendSend) UnmarshalJSON(bytes []byte) (err error) {
	varLinksSendSend := _LinksSendSend{}

	err = json.Unmarshal(bytes, &varLinksSendSend)
	if err == nil {
		*o = LinksSendSend(varLinksSendSend)
	} else {
		return err
	}
...
type NullableLinksSendSend struct {
	value *LinksSendSend
	isSet bool
}

func (v NullableLinksSendSend) Get() *LinksSendSend {
	return v.value
}

func (v *NullableLinksSendSend) Set(val *LinksSendSend) {
	v.value = val
	v.isSet = true
}

func (v NullableLinksSendSend) IsSet() bool {
	return v.isSet
}

func (v *NullableLinksSendSend) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinksSendSend(val *LinksSendSend) *NullableLinksSendSend {
	return &NullableLinksSendSend{value: val, isSet: true}
}

func (v NullableLinksSendSend) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinksSendSend) UnmarshalJSON(src []byte) error {
	v.isSet = true
