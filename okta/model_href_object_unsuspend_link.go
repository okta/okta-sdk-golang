...
// checks if the HrefObjectUnsuspendLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HrefObjectUnsuspendLink{}

// HrefObjectUnsuspendLink Link to unsuspend the resource
type HrefObjectUnsuspendLink struct {
...
type _HrefObjectUnsuspendLink HrefObjectUnsuspendLink
...
func (o HrefObjectUnsuspendLink) MarshalJSON() ([]byte, error) {
...
func (o HrefObjectUnsuspendLink) ToMap() (map[string]interface{}, error) {
...
func (o *HrefObjectUnsuspendLink) UnmarshalJSON(data []byte) (err error) {
	...
	varHrefObjectUnsuspendLink := _HrefObjectUnsuspendLink{}

	err = json.Unmarshal(data, &varHrefObjectUnsuspendLink)

	if err != nil {
		return err
	}

	*o = HrefObjectUnsuspendLink(varHrefObjectUnsuspendLink)
...
type NullableHrefObjectUnsuspendLink struct {
	value *HrefObjectUnsuspendLink
	isSet bool
}

func (v NullableHrefObjectUnsuspendLink) Get() *HrefObjectUnsuspendLink {
	return v.value
}

func (v *NullableHrefObjectUnsuspendLink) Set(val *HrefObjectUnsuspendLink) {
	v.value = val
	v.isSet = true
}

func (v NullableHrefObjectUnsuspendLink) IsSet() bool {
	return v.isSet
}

func (v *NullableHrefObjectUnsuspendLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHrefObjectUnsuspendLink(val *HrefObjectUnsuspendLink) *NullableHrefObjectUnsuspendLink {
	return &NullableHrefObjectUnsuspendLink{value: val, isSet: true}
}

func (v NullableHrefObjectUnsuspendLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHrefObjectUnsuspendLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
