...
type LinksActivateActivate struct {
...
type _LinksActivateActivate LinksActivateActivate
...
func (o LinksActivateActivate) MarshalJSON() ([]byte, error) {
...
func (o *LinksActivateActivate) UnmarshalJSON(bytes []byte) (err error) {
	varLinksActivateActivate := _LinksActivateActivate{}

	err = json.Unmarshal(bytes, &varLinksActivateActivate)
	if err == nil {
		*o = LinksActivateActivate(varLinksActivateActivate)
	} else {
		return err
	}
...
type NullableLinksActivateActivate struct {
	value *LinksActivateActivate
	isSet bool
}

func (v NullableLinksActivateActivate) Get() *LinksActivateActivate {
	return v.value
}

func (v *NullableLinksActivateActivate) Set(val *LinksActivateActivate) {
	v.value = val
	v.isSet = true
}

func (v NullableLinksActivateActivate) IsSet() bool {
	return v.isSet
}

func (v *NullableLinksActivateActivate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinksActivateActivate(val *LinksActivateActivate) *NullableLinksActivateActivate {
	return &NullableLinksActivateActivate{value: val, isSet: true}
}

func (v NullableLinksActivateActivate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinksActivateActivate) UnmarshalJSON(src []byte) error {
	v.isSet = true
