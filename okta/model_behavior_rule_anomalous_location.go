...
// checks if the BehaviorRuleAnomalousLocation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BehaviorRuleAnomalousLocation{}
...
func (o BehaviorRuleAnomalousLocation) ToMap() (map[string]interface{}, error) {
...
func (o *BehaviorRuleAnomalousLocation) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varBehaviorRuleAnomalousLocationWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varBehaviorRuleAnomalousLocation)
	if err == nil {
