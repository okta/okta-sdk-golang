...
// checks if the SecurityEventTokenJwtHeader type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SecurityEventTokenJwtHeader{}
...
func (o SecurityEventTokenJwtHeader) ToMap() (map[string]interface{}, error) {
...
func (o *SecurityEventTokenJwtHeader) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSecurityEventTokenJwtHeader)
