...
type UserFactorPush struct {
	...
	FactorResult         *UserFactorResultType  `json:"factorResult,omitempty"`
...
// SetFactorResult gets a reference to the given UserFactorResultType and assigns it to the FactorResult field.
