...
type DomainLinksAllOfVerify struct {
...
type _DomainLinksAllOfVerify DomainLinksAllOfVerify
...
func (o DomainLinksAllOfVerify) MarshalJSON() ([]byte, error) {
...
func (o *DomainLinksAllOfVerify) UnmarshalJSON(bytes []byte) (err error) {
	varDomainLinksAllOfVerify := _DomainLinksAllOfVerify{}

	err = json.Unmarshal(bytes, &varDomainLinksAllOfVerify)
	if err == nil {
		*o = DomainLinksAllOfVerify(varDomainLinksAllOfVerify)
	} else {
		return err
	}
...
type NullableDomainLinksAllOfVerify struct {
	value *DomainLinksAllOfVerify
	isSet bool
}

func (v NullableDomainLinksAllOfVerify) Get() *DomainLinksAllOfVerify {
	return v.value
}

func (v *NullableDomainLinksAllOfVerify) Set(val *DomainLinksAllOfVerify) {
	v.value = val
	v.isSet = true
}

func (v NullableDomainLinksAllOfVerify) IsSet() bool {
	return v.isSet
}

func (v *NullableDomainLinksAllOfVerify) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDomainLinksAllOfVerify(val *DomainLinksAllOfVerify) *NullableDomainLinksAllOfVerify {
	return &NullableDomainLinksAllOfVerify{value: val, isSet: true}
}

func (v NullableDomainLinksAllOfVerify) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDomainLinksAllOfVerify) UnmarshalJSON(src []byte) error {
	v.isSet = true
