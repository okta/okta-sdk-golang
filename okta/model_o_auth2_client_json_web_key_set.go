...
type OAuth2ClientJsonWebKeySet struct {
	...
	Keys                 []OAuth2ClientJsonWebKeySetKeysInner `json:"keys,omitempty"`
...
func (o *OAuth2ClientJsonWebKeySet) GetKeys() []OAuth2ClientJsonWebKeySetKeysInner {
	if o == nil || IsNil(o.Keys) {
		var ret []OAuth2ClientJsonWebKeySetKeysInner
		return ret
	}
	return o.Keys
}
...
func (o *OAuth2ClientJsonWebKeySet) GetKeysOk() ([]OAuth2ClientJsonWebKeySetKeysInner, bool) {
	if o == nil || IsNil(o.Keys) {
		return nil, false
	}
	return o.Keys, true
...
// SetKeys gets a reference to the given []OAuth2ClientJsonWebKeySetKeysInner and assigns it to the Keys field.
func (o *OAuth2ClientJsonWebKeySet) SetKeys(v []OAuth2ClientJsonWebKeySetKeysInner) {
	o.Keys = v
}
