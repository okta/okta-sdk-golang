...
func (m *NetworkZoneResource) ActivateNetworkZone(ctx context.Context, zoneId string) (*Response, error) {
...
func (m *NetworkZoneResource) DeactivateNetworkZone(ctx context.Context, zoneId string) (*Response, error) {
