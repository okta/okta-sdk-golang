...
type UserClassificationAPI interface {
	...
	*/
	...
	// GetUserClassificationExecute executes the request
	...
	*/
	...
	// ReplaceUserClassificationExecute executes the request
	//  @return UserClassification
	ReplaceUserClassificationExecute(r ApiReplaceUserClassificationRequest) (*UserClassification, *APIResponse, error)
}

// UserClassificationAPIService UserClassificationAPI service
...
func (r ApiGetUserClassificationRequest) Execute() (*UserClassification, *APIResponse, error) {
	return r.ApiService.GetUserClassificationExecute(r)
}
...
func (a *UserClassificationAPIService) GetUserClassificationExecute(r ApiGetUserClassificationRequest) (*UserClassification, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserClassificationAPIService.GetUserClassification")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/users/{userId}/classification"
...
func (r ApiReplaceUserClassificationRequest) ReplaceUserClassification(replaceUserClassification ReplaceUserClassification) ApiReplaceUserClassificationRequest {
	r.replaceUserClassification = &replaceUserClassification
	return r
}

func (r ApiReplaceUserClassificationRequest) Execute() (*UserClassification, *APIResponse, error) {
	return r.ApiService.ReplaceUserClassificationExecute(r)
}
...
func (a *UserClassificationAPIService) ReplaceUserClassificationExecute(r ApiReplaceUserClassificationRequest) (*UserClassification, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserClassificationAPIService.ReplaceUserClassification")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.replaceUserClassification == nil {
		return localVarReturnValue, nil, reportError("replaceUserClassification is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.replaceUserClassification
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiToken"]; ok {
