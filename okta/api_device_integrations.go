...
type DeviceIntegrationsAPI interface {
	...
	*/
	...
	// ActivateDeviceIntegrationExecute executes the request
	...
	*/
	...
	// DeactivateDeviceIntegrationExecute executes the request
	//  @return DeviceIntegrations
	...
	*/
	...
	// GetDeviceIntegrationExecute executes the request
	//  @return DeviceIntegrations
	...
	*/
	...
	// ListDeviceIntegrationsExecute executes the request
	//  @return []DeviceIntegrations
	ListDeviceIntegrationsExecute(r ApiListDeviceIntegrationsRequest) ([]DeviceIntegrations, *APIResponse, error)
}

// DeviceIntegrationsAPIService DeviceIntegrationsAPI service
...
func (r ApiActivateDeviceIntegrationRequest) Execute() (*DeviceIntegrations, *APIResponse, error) {
	return r.ApiService.ActivateDeviceIntegrationExecute(r)
}
...
func (a *DeviceIntegrationsAPIService) ActivateDeviceIntegrationExecute(r ApiActivateDeviceIntegrationRequest) (*DeviceIntegrations, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeviceIntegrationsAPIService.ActivateDeviceIntegration")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/device-integrations/{deviceIntegrationId}/lifecycle/activate"
	localVarPath = strings.Replace(localVarPath, "{"+"deviceIntegrationId"+"}", url.PathEscape(parameterToString(r.deviceIntegrationId, "")), -1)
...
func (r ApiDeactivateDeviceIntegrationRequest) Execute() (*DeviceIntegrations, *APIResponse, error) {
	return r.ApiService.DeactivateDeviceIntegrationExecute(r)
}
...
func (a *DeviceIntegrationsAPIService) DeactivateDeviceIntegrationExecute(r ApiDeactivateDeviceIntegrationRequest) (*DeviceIntegrations, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeviceIntegrationsAPIService.DeactivateDeviceIntegration")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/device-integrations/{deviceIntegrationId}/lifecycle/deactivate"
	localVarPath = strings.Replace(localVarPath, "{"+"deviceIntegrationId"+"}", url.PathEscape(parameterToString(r.deviceIntegrationId, "")), -1)
...
func (r ApiGetDeviceIntegrationRequest) Execute() (*DeviceIntegrations, *APIResponse, error) {
	return r.ApiService.GetDeviceIntegrationExecute(r)
}
...
func (a *DeviceIntegrationsAPIService) GetDeviceIntegrationExecute(r ApiGetDeviceIntegrationRequest) (*DeviceIntegrations, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeviceIntegrationsAPIService.GetDeviceIntegration")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/device-integrations/{deviceIntegrationId}"
	localVarPath = strings.Replace(localVarPath, "{"+"deviceIntegrationId"+"}", url.PathEscape(parameterToString(r.deviceIntegrationId, "")), -1)
...
func (r ApiListDeviceIntegrationsRequest) Execute() ([]DeviceIntegrations, *APIResponse, error) {
	return r.ApiService.ListDeviceIntegrationsExecute(r)
}
...
func (a *DeviceIntegrationsAPIService) ListDeviceIntegrationsExecute(r ApiListDeviceIntegrationsRequest) ([]DeviceIntegrations, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeviceIntegrationsAPIService.ListDeviceIntegrations")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/device-integrations"
