...
type GovernanceBundleAPI interface {
	...
	*/
	...
	// CreateGovernanceBundleExecute executes the request
	...
	*/
	...
	// DeleteGovernanceBundleExecute executes the request
	...
	*/
	...
	// GetGovernanceBundleExecute executes the request
	//  @return GovernanceBundle
	...
	*/
	...
	// GetOptInStatusExecute executes the request
	...
	*/
	...
	// ListBundleEntitlementValuesExecute executes the request
	...
	*/
	...
	// ListBundleEntitlementsExecute executes the request
	...
	*/
	...
	// ListGovernanceBundlesExecute executes the request
	...
	*/
	...
	// OptInExecute executes the request
	//  @return OptInStatusResponse
	...
	*/
	...
	// OptOutExecute executes the request
	//  @return OptInStatusResponse
	...
	*/
	...
	// ReplaceGovernanceBundleExecute executes the request
	//  @return GovernanceBundle
	ReplaceGovernanceBundleExecute(r ApiReplaceGovernanceBundleRequest) (*GovernanceBundle, *APIResponse, error)
}

// GovernanceBundleAPIService GovernanceBundleAPI service
...
func (r ApiCreateGovernanceBundleRequest) GovernanceBundleCreateRequest(governanceBundleCreateRequest GovernanceBundleCreateRequest) ApiCreateGovernanceBundleRequest {
	r.governanceBundleCreateRequest = &governanceBundleCreateRequest
	return r
}

func (r ApiCreateGovernanceBundleRequest) Execute() (*GovernanceBundle, *APIResponse, error) {
	return r.ApiService.CreateGovernanceBundleExecute(r)
}
...
func (a *GovernanceBundleAPIService) CreateGovernanceBundleExecute(r ApiCreateGovernanceBundleRequest) (*GovernanceBundle, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GovernanceBundleAPIService.CreateGovernanceBundle")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/iam/governance/bundles"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.governanceBundleCreateRequest == nil {
		return localVarReturnValue, nil, reportError("governanceBundleCreateRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.governanceBundleCreateRequest
	if r.ctx != nil {
...
func (r ApiDeleteGovernanceBundleRequest) Execute() (*APIResponse, error) {
	return r.ApiService.DeleteGovernanceBundleExecute(r)
}
...
// Execute executes the request
func (a *GovernanceBundleAPIService) DeleteGovernanceBundleExecute(r ApiDeleteGovernanceBundleRequest) (*APIResponse, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GovernanceBundleAPIService.DeleteGovernanceBundle")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/iam/governance/bundles/{bundleId}"
...
func (r ApiGetGovernanceBundleRequest) Execute() (*GovernanceBundle, *APIResponse, error) {
	return r.ApiService.GetGovernanceBundleExecute(r)
}
...
func (a *GovernanceBundleAPIService) GetGovernanceBundleExecute(r ApiGetGovernanceBundleRequest) (*GovernanceBundle, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GovernanceBundleAPIService.GetGovernanceBundle")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetOptInStatusRequest) Execute() (*OptInStatusResponse, *APIResponse, error) {
	return r.ApiService.GetOptInStatusExecute(r)
}
...
func (a *GovernanceBundleAPIService) GetOptInStatusExecute(r ApiGetOptInStatusRequest) (*OptInStatusResponse, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GovernanceBundleAPIService.GetOptInStatus")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/iam/governance/optIn"
...
func (r ApiListBundleEntitlementValuesRequest) Limit(limit int32) ApiListBundleEntitlementValuesRequest {
	r.limit = &limit
	return r
}

func (r ApiListBundleEntitlementValuesRequest) Execute() (*EntitlementValuesResponse, *APIResponse, error) {
	return r.ApiService.ListBundleEntitlementValuesExecute(r)
}
...
func (a *GovernanceBundleAPIService) ListBundleEntitlementValuesExecute(r ApiListBundleEntitlementValuesRequest) (*EntitlementValuesResponse, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GovernanceBundleAPIService.ListBundleEntitlementValues")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/iam/governance/bundles/{bundleId}/entitlements/{entitlementId}/values"
	localVarPath = strings.Replace(localVarPath, "{"+"bundleId"+"}", url.PathEscape(parameterToString(r.bundleId, "")), -1)
...
// A limit on the number of objects to return
func (r ApiListBundleEntitlementsRequest) Limit(limit int32) ApiListBundleEntitlementsRequest {
	r.limit = &limit
	return r
}

func (r ApiListBundleEntitlementsRequest) Execute() (*BundleEntitlementsResponse, *APIResponse, error) {
	return r.ApiService.ListBundleEntitlementsExecute(r)
}
...
func (a *GovernanceBundleAPIService) ListBundleEntitlementsExecute(r ApiListBundleEntitlementsRequest) (*BundleEntitlementsResponse, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GovernanceBundleAPIService.ListBundleEntitlements")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/iam/governance/bundles/{bundleId}/entitlements"
	localVarPath = strings.Replace(localVarPath, "{"+"bundleId"+"}", url.PathEscape(parameterToString(r.bundleId, "")), -1)
...
// A limit on the number of objects to return
func (r ApiListGovernanceBundlesRequest) Limit(limit int32) ApiListGovernanceBundlesRequest {
	r.limit = &limit
	return r
}

func (r ApiListGovernanceBundlesRequest) Execute() (*GovernanceBundlesResponse, *APIResponse, error) {
	return r.ApiService.ListGovernanceBundlesExecute(r)
}
...
func (a *GovernanceBundleAPIService) ListGovernanceBundlesExecute(r ApiListGovernanceBundlesRequest) (*GovernanceBundlesResponse, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GovernanceBundleAPIService.ListGovernanceBundles")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiOptInRequest) Execute() (*OptInStatusResponse, *APIResponse, error) {
...
func (a *GovernanceBundleAPIService) OptInExecute(r ApiOptInRequest) (*OptInStatusResponse, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GovernanceBundleAPIService.OptIn")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiOptOutRequest) Execute() (*OptInStatusResponse, *APIResponse, error) {
...
func (a *GovernanceBundleAPIService) OptOutExecute(r ApiOptOutRequest) (*OptInStatusResponse, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GovernanceBundleAPIService.OptOut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/iam/governance/optOut"
...
func (r ApiReplaceGovernanceBundleRequest) GovernanceBundleUpdateRequest(governanceBundleUpdateRequest GovernanceBundleUpdateRequest) ApiReplaceGovernanceBundleRequest {
	r.governanceBundleUpdateRequest = &governanceBundleUpdateRequest
	return r
}

func (r ApiReplaceGovernanceBundleRequest) Execute() (*GovernanceBundle, *APIResponse, error) {
	return r.ApiService.ReplaceGovernanceBundleExecute(r)
}
...
func (a *GovernanceBundleAPIService) ReplaceGovernanceBundleExecute(r ApiReplaceGovernanceBundleRequest) (*GovernanceBundle, *APIResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GovernanceBundleAPIService.ReplaceGovernanceBundle")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.governanceBundleUpdateRequest == nil {
		return localVarReturnValue, nil, reportError("governanceBundleUpdateRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.governanceBundleUpdateRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiToken"]; ok {
