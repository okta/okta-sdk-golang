...
// ZoomUsApplicationAllOf struct for ZoomUsApplicationAllOf
type ZoomUsApplicationAllOf struct {
...
type _ZoomUsApplicationAllOf ZoomUsApplicationAllOf
...
func (o ZoomUsApplicationAllOf) MarshalJSON() ([]byte, error) {
...
func (o *ZoomUsApplicationAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varZoomUsApplicationAllOf := _ZoomUsApplicationAllOf{}

	err = json.Unmarshal(bytes, &varZoomUsApplicationAllOf)
	if err == nil {
		*o = ZoomUsApplicationAllOf(varZoomUsApplicationAllOf)
	} else {
		return err
	}
...
type NullableZoomUsApplicationAllOf struct {
	value *ZoomUsApplicationAllOf
	isSet bool
}

func (v NullableZoomUsApplicationAllOf) Get() *ZoomUsApplicationAllOf {
	return v.value
}

func (v *NullableZoomUsApplicationAllOf) Set(val *ZoomUsApplicationAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableZoomUsApplicationAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableZoomUsApplicationAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZoomUsApplicationAllOf(val *ZoomUsApplicationAllOf) *NullableZoomUsApplicationAllOf {
	return &NullableZoomUsApplicationAllOf{value: val, isSet: true}
}

func (v NullableZoomUsApplicationAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZoomUsApplicationAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
