...
// checks if the UserFactorU2F type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserFactorU2F{}
...
func (o UserFactorU2F) ToMap() (map[string]interface{}, error) {
...
func (o *UserFactorU2F) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varUserFactorU2FWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varUserFactorU2F)
	if err == nil {
