...
// checks if the HelpLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HelpLink{}

// HelpLink Link to the app help resource
...
func (o HelpLink) ToMap() (map[string]interface{}, error) {
...
func (o *HelpLink) UnmarshalJSON(data []byte) (err error) {
	...
	varHelpLink := _HelpLink{}

	err = json.Unmarshal(data, &varHelpLink)

	if err != nil {
		return err
	}

	*o = HelpLink(varHelpLink)
...
type NullableHelpLink struct {
	value *HelpLink
	isSet bool
}

func (v NullableHelpLink) Get() *HelpLink {
	return v.value
}

func (v *NullableHelpLink) Set(val *HelpLink) {
	v.value = val
	v.isSet = true
}

func (v NullableHelpLink) IsSet() bool {
	return v.isSet
}

func (v *NullableHelpLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHelpLink(val *HelpLink) *NullableHelpLink {
	return &NullableHelpLink{value: val, isSet: true}
}

func (v NullableHelpLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHelpLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
