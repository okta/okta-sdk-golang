...
type ApplicationFeature struct {
	...
	Name                 *ApplicationFeatureType  `json:"name,omitempty"`
...
func (o *ApplicationFeature) GetName() ApplicationFeatureType {
	if o == nil || o.Name == nil {
		var ret ApplicationFeatureType
		return ret
	}
	return *o.Name
}
...
// SetName gets a reference to the given ApplicationFeatureType and assigns it to the Name field.
