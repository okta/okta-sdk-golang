...
// ApplicationFeature The Feature object is used to configure application feature settings.  The only feature currently supported is `USER_PROVISIONING` for the Org2Org application type.
type ApplicationFeature struct {
	Capabilities *ApplicationFeatureCapabilities `json:"capabilities,omitempty"`
...
func (o *ApplicationFeature) GetCapabilities() ApplicationFeatureCapabilities {
	if o == nil || o.Capabilities == nil {
		var ret ApplicationFeatureCapabilities
		return ret
	}
...
// SetCapabilities gets a reference to the given ApplicationFeatureCapabilities and assigns it to the Capabilities field.
