...
type AuthServerLinksAllOfClaims struct {
...
type _AuthServerLinksAllOfClaims AuthServerLinksAllOfClaims
...
func NewAuthServerLinksAllOfClaims(href string) *AuthServerLinksAllOfClaims {
	this := AuthServerLinksAllOfClaims{}
	this.Href = href
	return &this
}
...
func (o AuthServerLinksAllOfClaims) MarshalJSON() ([]byte, error) {
...
func (o *AuthServerLinksAllOfClaims) UnmarshalJSON(bytes []byte) (err error) {
	varAuthServerLinksAllOfClaims := _AuthServerLinksAllOfClaims{}

	err = json.Unmarshal(bytes, &varAuthServerLinksAllOfClaims)
	if err == nil {
		*o = AuthServerLinksAllOfClaims(varAuthServerLinksAllOfClaims)
	} else {
		return err
	}
...
type NullableAuthServerLinksAllOfClaims struct {
	value *AuthServerLinksAllOfClaims
	isSet bool
}

func (v NullableAuthServerLinksAllOfClaims) Get() *AuthServerLinksAllOfClaims {
	return v.value
}

func (v *NullableAuthServerLinksAllOfClaims) Set(val *AuthServerLinksAllOfClaims) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthServerLinksAllOfClaims) IsSet() bool {
	return v.isSet
}

func (v *NullableAuthServerLinksAllOfClaims) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuthServerLinksAllOfClaims(val *AuthServerLinksAllOfClaims) *NullableAuthServerLinksAllOfClaims {
	return &NullableAuthServerLinksAllOfClaims{value: val, isSet: true}
}

func (v NullableAuthServerLinksAllOfClaims) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuthServerLinksAllOfClaims) UnmarshalJSON(src []byte) error {
	v.isSet = true
