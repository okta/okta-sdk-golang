...
// checks if the PasswordPolicyRecoveryEmail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PasswordPolicyRecoveryEmail{}
...
func (o PasswordPolicyRecoveryEmail) ToMap() (map[string]interface{}, error) {
...
func (o *PasswordPolicyRecoveryEmail) UnmarshalJSON(data []byte) (err error) {
	varPasswordPolicyRecoveryEmail := _PasswordPolicyRecoveryEmail{}

	err = json.Unmarshal(data, &varPasswordPolicyRecoveryEmail)
