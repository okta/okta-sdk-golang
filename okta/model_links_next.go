...
// checks if the LinksNext type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LinksNext{}
...
func (o LinksNext) ToMap() (map[string]interface{}, error) {
...
func (o *LinksNext) UnmarshalJSON(data []byte) (err error) {
	varLinksNext := _LinksNext{}

	err = json.Unmarshal(data, &varLinksNext)
