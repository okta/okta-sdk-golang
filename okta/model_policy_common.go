...
func (o *PolicyCommon) GetEmbedded() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *PolicyCommon) GetEmbeddedOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.Embedded) {
...
func (o *PolicyCommon) SetEmbedded(v map[string]interface{}) {
	o.Embedded = v
}
